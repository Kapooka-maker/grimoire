...
const SORTS = [
    {
        id: 1,
        nom: 'Amélioration de caractéristique',
        classe: ['Barde'],
        niveau: 2,
        ecole: 'Transmutation',
        temps: '1 action',
        ...
        description: "Vous touchez une créature pour lui accorder une amélioration magique. Choisissez l'un des effets suivants, dont la cible bénéficiera jusqu'à la fin du sort : Endurance de l'ours, Force du taureau, Grâce du chat, Splendeur de l'aigle, Ruse du renard ou Sagesse du hibou."
    },
    {
        id: 2,
        ...
        duree: '24 heures',
        description: 'Grâce à ce sort, vous convainquez une bête que vous ne lui voulez aucun mal. Choisissez une bête située dans votre champ de vision et à portée. Le sort échoue si elle possède une Intelligence de 4 ou plus. Dans le cas contraire, elle doit réussir un jet de sauvegarde de Sagesse ou être charmée par vous pendant toute la durée du sort.'
    },
    {
        id: 3,
        nom: 'Animation des objets',
        classe: ['Barde'],
        niveau: 5,
        ecole: 'Transmutation',
        temps: '1 action',
        ...
        description: "Les objets prennent vie sur votre ordre. Choisissez jusqu'à dix objets non magiques à portée que personne ne porte ni ne transporte. Chaque cible s'anime et devient une créature placée sous votre contrôle jusqu'à la fin du sort, ou jusqu'à tomber à 0 point de vie."
    },
    {
        id: 4,
        nom: 'Apaisement des émotions',
        classe: ['Barde'],
        niveau: 2,
        ecole: 'Enchantement',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous tentez de supprimer les émotions fortes au sein d'un groupe de gens. Chaque humanoïde qui se trouve dans une sphère de 6 mètres de rayon centrée autour d'un point de votre choix situé à portée doit faire un jet de sauvegarde de Charisme. En cas d'échec, vous pouvez neutraliser un état charmé/terrorisé ou rendre la cible indifférente envers des créatures qu'elle considérait comme hostiles."
    },
    {
        id: 5,
        nom: 'Apparence trompeuse',
        classe: ['Barde'],
        niveau: 5,
        ecole: 'Illusion',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: '8 heures',
        description: "Ce sort vous permet de modifier l'apparence d'autant de créatures que vous voulez à portée et dans votre champ de vision. Vous donnez à chacune d'entre elles une nouvelle apparence illusoire. Une cible non consentante peut tenter un jet de sauvegarde de Charisme."
    },
    {
        id: 6,
        nom: 'Aura du héros',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Une aura captivante émane de vous dans un rayon de 1,50 mètre. Vous bénéficiez d'un avantage à tous vos tests de Charisme visant les créatures situées dans l'aura."
    },
    {
        id: 7,
        nom: 'Bagou',
        ...
        composantes: 'V',
        duree: '1 heure',
        description: "Jusqu'à la fin du sort, chaque fois que vous effectuez un test de Charisme, vous pouvez remplacer le nombre obtenu au dé par un 15. De plus, la magie visant à déterminer si vous dites la vérité vous identifie toujours comme sincère."
    },
    {
        id: 8,
        nom: 'Bouche magique',
        ...
        description: 'Vous implantez un message dans un objet situé à portée. On entend le message (25 mots maximum) dès que les conditions visuelles ou audibles que vous avez définies pour le déclencher sont remplies.'
    },
    {
        id: 9,
        nom: 'Briser',
        ...
        duree: 'Instantanée',
        description: 'Un bruit retentit soudain avec une intensité douloureuse. Chaque créature située dans une sphère de 3 mètres de rayon centrée sur ce point doit faire un jet de sauvegarde de Constitution ou subir 3d8 dégâts de tonnerre (moitié en cas de réussite).'
    },
    {
        id: 10,
        nom: 'Cage de force',
        ...
        duree: '1 heure',
        description: "Une prison immobile et invisible, en forme de cube et faite de force magique, se forme soudain autour d'une zone de votre choix située à portée (cage de 6m d'arête ou boîte hermétique de 3m d'arête) pour y emprisonner les créatures."
    },
    {
        id: 11,
        nom: 'Catalepsie',
        ...
        duree: '1 heure',
        description: "Vous placez une créature vivante consentante en état cataleptique qu'il est impossible de distinguer d'un véritable état de mort par des moyens normaux. Le sujet est aveuglé, inconscient et incapable de bouger."
    },
    {
        id: 12,
        nom: 'Cécité/Surdité',
        ...
        composantes: 'V',
        duree: '1 minute',
        description: 'Vous pouvez rendre un ennemi sourd ou aveugle. Choisissez une créature située à portée. Elle doit effectuer un jet de sauvegarde de Constitution. Si elle échoue, elle est soit aveuglée, soit assourdie pendant toute la durée du sort.'
    },
    {
        id: 13,
        nom: 'Cercle de téléportation',
        classe: ['Barde'],
        niveau: 5,
        ecole: 'Invocation',
        temps: '1 minute',
        ...
        duree: '1 round',
        description: 'Vous tracez un cercle de 3 mètres de diamètre au sol qui crée un portail relié à un cercle de téléportation permanent de votre choix dont vous connaissez la séquence de symboles.'
    },
    {
        id: 14,
        nom: 'Charme-personne',
        ...
        composantes: 'V, S',
        duree: '1 heure',
        description: "Vous tentez de charmer un humanoïde se trouvant à portée. Il doit faire un jet de sauvegarde de Sagesse. S'il le rate, il est charmé par vous et vous considère comme un ami jusqu'à la fin du sort."
    },
    {
        id: 15,
        nom: 'Chauffer le métal',
        classe: ['Barde'],
        niveau: 2,
        ecole: 'Transmutation',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Choisissez un objet manufacturé en métal à portée. Il se met à luire d'un rouge incandescent. Une créature en contact physique avec l'objet subit 2d8 dégâts de feu et peut être contrainte de lâcher l'objet."
    },
    {
        id: 16,
        nom: 'Clairvoyance',
        ...
        composantes: "V, S, M (un focaliseur d'une valeur minimale de 100 po : corne incrustée de pierreries ou œil de verre)",
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Vous créez un organe sensoriel invisible à portée dans un endroit familier ou évidents. Vous pouvez choisir d'utiliser la vue ou l'ouïe à travers cet organe comme si vous y étiez."
    },
    {
        id: 17,
        nom: 'Coercition mystique',
        classe: ['Barde'],
        niveau: 5,
        ecole: 'Enchantement',
        temps: '1 minute',
        ...
        composantes: 'V',
        duree: '30 jours',
        description: "Vous imposez une coercition magique à une créature située à portée, l'obligeant à vous accorder un service ou l'empêchant de commettre une action. En cas d'échec au jet de Sagesse, la cible est charmée et subit 5d10 dégâts psychiques si elle agit contre vos instructions."
    },
    {
        id: 18,
        nom: 'Communication avec les animaux',
        classe: ['Barde'],
        niveau: 1,
        ecole: 'Divination',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: '10 minutes',
        description: 'Vous devenez capable de comprendre les bêtes et de communiquer verbalement avec elles pendant toute la durée du sort.'
    },
    {
        id: 19,
        ...
        duree: '10 minutes',
        description: "Vous donnez un semblant de vie et d'intelligence à un cadavre situé à portée pour qu'il meure réponde à cinq de vos questions. Ses connaissances se limitent à ce qu'il savait de son vivant."
    },
    {
        id: 20,
        nom: 'Communication avec les plantes',
        classe: ['Barde'],
        niveau: 3,
        ecole: 'Transmutation',
        temps: '1 action',
        portee: 'Personnelle (9 mètres de rayon)',
        composantes: 'V, S',
        duree: '10 minutes',
        description: "Vous imprégnez la végétation située dans un rayon de 9 mètres d'une conscience et d'une mobilité limitées, ce qui permet aux plantes de communiquer avec vous et de suivre des ordres simples."
    },
    {
        id: 21,
        ...
        duree: '1 heure',
        description: 'Pendant toute la durée du sort, vous comprenez le sens littéral de tout langage parlé que vous entendez ainsi que les langues écrites que vous voyez en touchant la surface.'
    },
    {
        id: 22,
        nom: 'Compulsion',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: 'Les créatures ciblées doivent réussir un jet de sauvegarde de Sagesse ou être forcées de se déplacer dans la direction que vous désignez par une action bonus à chacun de vos tours.'
    },
    {
        id: 23,
        nom: 'Confusion',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Ce sort assaille l'esprit des créatures dans une sphère de 3 mètres de rayon. En cas d'échec au jet de Sagesse, la cible ne peut plus utiliser de réaction et doit lancer 1d10 à chaque tour pour déterminer son comportement aléatoire."
    },
    {
        id: 24,
        nom: 'Croissance végétale',
        classe: ['Barde'],
        niveau: 3,
        ecole: 'Transmutation',
        temps: '1 action ou 8 heures',
        portee: '45 mètres',
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "En 1 action, ce sort rend la végétation d'une zone de 30 mètres de rayon particulièrement touffue (terrain très difficile). En 8 heures, il enrichit la terre d'une zone de 800 mètres de rayon pour un an."
    },
    {
        id: 25,
        ...
        composantes: 'V',
        duree: "Concentration, jusqu'à 1 minute",
        description: "La cible entame une danse comique sur place. Elle doit dépenser tout son déplacement pour danser, subit un désavantage à ses jets d'attaque et de sauvegarde de Dextérité, et concède l'avantage aux attaques contre elle."
    },
    {
        id: 26,
        nom: 'Déblocage',
        ...
        composantes: 'V',
        duree: 'Instantanée',
        description: "Déverrouille ou débloque un objet fermé (porte, coffre, cadenas). Supprime un verrou magique pendant 10 minutes. L'incantation émet un cliquetis audible jusqu'à 90 mètres."
    },
    {
        id: 27,
        nom: 'Déguisement',
        ...
        composantes: 'V, S',
        duree: '1 heure',
        description: "Vous modifiez magiquement votre apparence physique, vos vêtements et vos armes jusqu'à la fin du sort. Un examen physique de près ou un test d'Investigation réussi peut percer l'illusion."
    },
    {
        id: 28,
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Vous percevez la présence de magie dans un rayon de 9 mètres. Vous pouvez dépenser une action pour discerner une faible aura autour d'une cible magique et apprendre l'école de magie associée."
    },
    {
        id: 29,
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous lisez les pensées superficielles d'une créature à moins de 9 mètres. Vous pouvez tenter de sonder plus profondément son esprit (jet de sauvegarde de Sagesse requis pour la cible)."
    },
    {
        id: 30,
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "Interrompt automatiquement tout sort de niveau 3 ou inférieur sur la cible. Pour un sort de niveau supérieur, nécessite un test de caractéristique d'incantation réussi contre un DD de 10 + niveau du sort."
    },
    {
        id: 31,
        nom: 'Dominer un humanoïde',
        classe: ['Barde'],
        niveau: 5,
        ecole: 'Enchantement',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Tente d'envoûter un humanoïde (jet de Sagesse). Tant qu'il est charmé, vous communiquez télépathiquement pour lui donner des ordres qu'il tente d'exécuter, ou vous pouvez en prendre le contrôle total via votre action."
    },
    {
        id: 32,
        nom: 'Dominer un monstre',
        classe: ['Barde'],
        niveau: 8,
        ecole: 'Enchantement',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 heure",
        description: "Tente d'envoûter n'importe quelle créature à portée (jet de Sagesse). Vous entretenez un lien télépathique avec elle pour lui donner des ordres ou prendre le contrôle direct de ses actions."
    },
    {
        id: 33,
        nom: 'Entrave planaire',
        classe: ['Barde'],
        niveau: 5,
        ecole: 'Abjuration',
        temps: '1 heure',
        ...
        duree: '24 heures',
        description: "Vous liez à vos services un céleste, un élémentaire, une fée ou un fiélon. En cas d'échec à son jet de Charisme, la créature est contrainte d'exécuter vos ordres pendant toute la durée du sort."
    },
    {
        id: 34,
        ...
        duree: '1 round',
        description: "Vous envoyez un court message d'au maximum 25 mots à une créature connue. Elle l'entend mentalement et peut y répondre immédiatement de la même manière, même à travers les plans."
    },
    {
        id: 35,
        nom: 'Envoûtement',
        ...
        composantes: 'V, S',
        duree: '1 minute',
        description: "Des paroles envoûtantes forcent les cibles choisies à effectuer un jet de sauvegarde de Sagesse. En cas d'échec, elles subissent un désavantage lors de leurs tests de Perception visant d'autres créatures que vous."
    },
    {
        id: 36,
        nom: 'Épée magique',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Crée une épée de force flottante. À l'apparition puis par action bonus à chaque tour, vous pouvez attaquer une cible au corps à corps pour lui infliger 3d10 dégâts de force."
    },
    {
        id: 37,
        nom: 'Esprit faible',
        ...
        duree: 'Instantanée',
        description: "Inflige 4d6 dégâts psychiques à une cible. Si elle échoue à son jet de sauvegarde d'Intelligence, ses valeurs d'Intelligence et de Charisme tombent à 1, l'empêchant de parler et de lancer des sorts."
    },
    {
        id: 38,
        ...
        composantes: 'V, S',
        duree: '24 heures',
        description: "Immunise une créature consentante contre les dégâts psychiques, les effets de lecture de pensées ou d'émotions, les sorts de divination, l'état charmé ainsi que les souhaits affectant son esprit."
    },
    {
        id: 39,
        nom: 'Éveil',
        ...
        duree: 'Instantanée',
        description: 'Accorde une Intelligence de 10, la parole et la mobilité (pour une plante) à un animal ou une plante non magique de taille TG ou inférieure. La cible est charmée par vous pendant 30 jours.'
    },
    {
        id: 40,
        nom: 'Fléau',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Jusqu'à trois créatures doivent réussir un jet de sauvegarde de Charisme. En cas d'échec, chaque fois qu'une cible effectue un jet d'attaque ou de sauvegarde, elle doit soustraire 1d4 du résultat."
    },
    {
        id: 41,
        nom: 'Forme éthérée',
        ...
        description: 'Vous vous déplacez dans la frontière du plan éthéré. Vous devenez invisible et intangible pour les créatures du plan matériel, ce qui vous permet de traverser les obstacles physiques.'
    },
    {
        id: 42,
        nom: 'Fou rire',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: 'Une créature à portée succombe à un fou rire irrépressible. Sur un échec au jet de Sagesse, elle se retrouve à terre, neutralisée et incapable de se relever pendant la durée du sort.'
    },
    {
        id: 43,
        nom: 'Glyphe de protection',
        classe: ['Barde'],
        niveau: 3,
        ecole: 'Abjuration',
        temps: '1 heure',
        ...
        description: 'Inscrit un glyphe magique piège sur une surface ou dans un objet. Lors du déclenchement défini, le glyphe génère soit des runes explosives (5d8 dégâts élémentaires), soit déclenche un sort stocké au préalable.'
    },
    {
        id: 44,
        nom: 'Grande foulée',
        ...
        duree: '1 heure',
        description: "Vous touchez une créature dont la vitesse de déplacement augmente de 3 mètres jusqu'à la fin du sort."
    },
    {
        id: 45,
        nom: 'Harmonique miraculeuse',
        classe: ['Barde'],
        niveau: 9,
        ecole: 'Évocation',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous et vos alliés à portée récupérez 10 PV et annulez un niveau d'épuisement au début de chaque tour. Le sort met fin aux diminutions de PV max ainsi qu'aux états charmé et pétrifié."
    },
    {
        id: 46,
        nom: 'Héroïsme',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "La cible touchée est immunisée contre l'état terrorisé et gagne au début de chacun de ses tours un nombre de points de vie temporaires égal à votre modificateur de caractéristique d'incantation."
    },
    {
        id: 47,
        nom: 'Identification',
        ...
        duree: 'Instantanée',
        description: "En touchant un objet pendant toute l'incantation, vous découvrez ses propriétés magiques, ses charges et ses conditions d'utilisation. Si vous touchez une créature, vous apprenez quels sorts l'affectent."
    },
    {
        id: 48,
        nom: 'Illusion mineure',
        classe: ['Barde'],
        niveau: 0,
        ecole: 'Illusion',
        temps: '1 action',
        ...
        duree: '1 minute',
        description: "Vous créez un son ou l'image d'un objet (tenant dans un cube de 1,50 m de côté) à portée. Un examen via un test d'Investigation permet à une créature de percer l'illusion à jour."
    },
    {
        id: 49,
        nom: 'Illusion programmée',
        classe: ['Barde'],
        niveau: 6,
        ecole: 'Illusion',
        temps: '1 action',
        ...
        duree: "Jusqu'à dissipation",
        description: "Crée une illusion complexe (visuelle et sonore) qui reste imperceptible jusqu'à ce que des conditions spécifiques se produisent. L'illusion joue ensuite sa séquence (5 min max) avant de se rendormir."
    },
    {
        id: 50,
        nom: 'Image majeure',
        ...
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Crée l'image d'un objet, créature ou phénomène dans un cube de 6m d'arête, avec sons, odeurs et température appropriés. Vous pouvez utiliser votre action pour déplacer et faire interagir l'image."
    },
    {
        id: 51,
        nom: 'Image projetée',
        ...
        description: 'Crée un double illusoire intangible de votre personne à portée. Vous pouvez le déplacer, le faire parler, et percevoir votre environnement à travers ses yeux et ses oreilles.'
    },
    {
        id: 52,
        ...
        composantes: 'V, S, M (un morceau de toison)',
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Crée l'image uniquement visuelle d'un objet, d'une créature ou d'un phénomène tenant dans un cube de 4,50 mètres de côté. Vous pouvez dépenser une action pour déplacer l'image."
    },
    {
        id: 53,
        nom: 'Immobiliser un humanoïde',
        classe: ['Barde'],
        niveau: 2,
        ecole: 'Enchantement',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Choisissez un humanoïde à portée. Il doit réussir un jet de sauvegarde de Sagesse sous peine d'être paralysé pendant toute la durée du sort. Un nouveau jet est accordé à la fin de chaque tour."
    },
    {
        id: 54,
        nom: 'Immobiliser un monstre',
        classe: ['Barde'],
        niveau: 5,
        ecole: 'Enchantement',
        temps: '1 action',
        ...
        composantes: 'V, S, M (un petit morceau de fer bien droit)',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Paralyse n'importe quelle créature ciblée (hors morts-vivants) en cas d'échec à un jet de sauvegarde de Sagesse. La cible peut refaire son jet de sauvegarde à la fin de chacun de ses tours."
    },
    {
        id: 55,
        nom: 'Instrument fantomatique',
        classe: ['Barde'],
        niveau: 1,
        ecole: 'Illusion',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: 'Crée un instrument de musique illusoire et invisible des autres qui suit la cible. Au début de chaque tour, la cible doit réussir un jet de Sagesse ou subir 2d4 dégâts psychiques et être étourdie.'
    },
    {
        id: 56,
        nom: 'Invisibilité',
        ...
        duree: "Concentration, jusqu'à 1 heure",
        description: 'La créature touchée devient invisible avec tout son équipement. Le sort prend fin immédiatement si la cible effectue une attaque ou lance un sort.'
    },
    {
        id: 57,
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: 'Vous ou une créature consentante touchée devenez invisible pendant toute la durée du sort, même si la cible attaque ou lance des sorts.'
    },
    {
        id: 58,
        nom: 'Jeter une malédiction',
        classe: ['Barde'],
        niveau: 3,
        ecole: 'Nécromancie',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Sur un échec au jet de Sagesse, la cible est maudite (au choix : désavantage à une caractéristique, désavantage d'attaque contre vous, pertes d'actions à chaque tour ou 1d8 dégâts nécrotiques supplémentaires)."
    },
    {
        id: 59,
        nom: 'Langues',
        ...
        duree: '1 heure',
        description: "Permet à la créature touchée de comprendre toutes les langues parlées qu'elle entend. De plus, tout ce qu'elle dit est compris par n'importe quelle créature maîtrisant au moins un langage."
    },
    {
        id: 60,
        nom: 'Légende',
        ...
        temps: '10 minutes',
        portee: 'Personnelle',
        composantes: "V, S, M (de l'encens d'une valeur minimale de 250 po consume et 4 bandelettes d'ivoire valant au moins 50 po chacune)",
        duree: 'Instantanée',
        description: "Révèle un résumé des connaissances essentielles (contes, savoirs secrets) se rapportant à une personne, un lieu ou un objet d'importance légendaire que vous nommez."
    },
    {
        id: 61,
        nom: 'Léger comme une plume',
        classe: ['Barde'],
        niveau: 1,
        ecole: 'Transmutation',
        temps: '1 réaction (quand une créature chute à moins de 18 mètres)',
        portee: '18 mètres',
        composantes: 'V, M (une petite plume ou un peu de duvet)',
        duree: '1 minute',
        description: "Ralentit la vitesse de chute de jusqu'à cinq créatures à 18 mètres par round. Les cibles ne subissent aucun dégât de chute si elles touchent le sol avant la fin du sort."
    },
    {
        id: 62,
        ...
        temps: '1 action',
        portee: 'Contact',
        composantes: "V, S, M (un lien de cuir enroulé autour d'un bras)",
        duree: '1 heure',
        description: "Les déplacements de la cible ne sont pas affectés par le terrain difficile, ni par les effets provoquant la paralysie ou l'état entravé. Échappe automatiquement aux empoignades et liens non magiques."
    },
    {
        id: 63,
        nom: 'Localiser des animaux ou des plantes',
        classe: ['Barde'],
        niveau: 2,
        ecole: 'Divination',
        temps: '1 action',
        ...
        duree: 'Instantanée',
        description: "Vous apprenez dans quelle direction et à quelle distance se trouve le spécimen le plus proche d'un type précis de bête ou de plante dans un rayon de 7,5 kilomètres."
    },
    {
        id: 64,
        nom: 'Localiser un objet',
        classe: ['Barde'],
        niveau: 2,
        ecole: 'Divination',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Vous sentez la direction dans laquelle se trouve un objet spécifique ou un type d'objet connu situé dans un rayon de 300 mètres (le plomb bloque cet effet)."
    },
    {
        id: 65,
        nom: 'Localiser une créature',
        classe: ['Barde'],
        niveau: 4,
        ecole: 'Divination',
        temps: '1 action',
        ...
        composantes: 'V, S, M (des poils de chien de chasse)',
        duree: "Concentration, jusqu'à 1 heure",
        description: "Vous sentez la direction dans laquelle se trouve une créature spécifique ou la plus proche d'un type donné dans un rayon de 300 mètres, à condition de l'avoir déjà vue de près."
    },
    {
        id: 66,
        nom: 'Lueurs féeriques',
        classe: ['Barde'],
        niveau: 1,
        ecole: 'Évocation',
        temps: '1 action',
        ...
        composantes: 'V',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Les objets et créatures ratant un jet de Dextérité dans un cube de 6 mètres sont entourés de lumière. Les attaques contre eux bénéficient d'un avantage et ils ne peuvent pas être invisibles."
    },
    {
        id: 67,
        nom: 'Lumière',
        ...
        duree: '1 heure',
        description: "L'objet touché émet une vive lumière dans un rayon de 6 mètres et une lumière faible sur 6 mètres additionnels. Un jet de Dextérité est requis si l'objet est porté par un ennemi."
    },
    {
        id: 68,
        nom: 'Lumières dansantes',
        classe: ['Barde'],
        niveau: 0,
        ecole: 'Évocation',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Crée jusqu'à quatre lumières flottantes de la taille d'une torche (ou une forme humanoïde). Vous pouvez les déplacer de 18 mètres par action bonus à chaque tour."
    },
    {
        id: 69,
        nom: 'Main du mage',
        ...
        composantes: 'V, S',
        duree: '1 minute',
        description: 'Une main spectrale flottante apparaît et peut être contrôlée par une action pour manipuler des objets, ouvrir des conteneurs ou verser des flacons (limite de 5 kg, ne peut pas attaquer).'
    },
    {
        id: 70,
        nom: 'Manoir somptueux',
        classe: ['Barde'],
        niveau: 7,
        ecole: 'Invocation',
        temps: '1 minute',
        portee: '90 mètres',
        composantes: "V, S, M (un portrait miniature gravé dans de l'ivoire, un bout de marbre poli et une cuillère en argent, valant chacun au moins 5 po)",
        duree: '24 heures',
        description: "Vous invoquez une demeure extraplanaire luxueuse comprenant jusqu'à 50 cubes de 3m d'arête, un banquet pour 100 personnes et une équipe de 100 serviteurs translucides à vos ordres."
    },
    {
        id: 71,
        nom: 'Mauvais œil',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: 'Vos yeux deviennent terrifiants. Vous pouvez cibler des créatures à 18m par une action pour leur infliger un effet (Nauséeux, Endormi ou Paniqué) sur un échec au jet de Sagesse.'
    },
    {
        id: 72,
        nom: 'Message',
        ...
        composantes: 'V, S, M (un petit bout de fil de cuivre)',
        duree: '1 round',
        description: "Vous chuchotez un message vers une cible à portée qui est la seule à l'entendre et qui peut vous répondre par un murmure en retour, même à travers certains obstacles."
    },
    {
        id: 73,
        nom: 'Messager animal',
        ...
        composantes: 'V, S, M (un peu de nourriture)',
        duree: '24 heures',
        description: "Vous chargez une bête de taille TP (oiseau, rongeur...) d'aller délivrer un message vocal de 25 mots maximum à un destinataire décrit situé dans une autre localité."
    },
    {
        id: 74,
        nom: 'Métamorphose',
        ...
        duree: "Concentration, jusqu'à 1 heure",
        description: "Change la forme d'une créature en une bête de votre choix d'un FP égal ou inférieur à celui de la cible. Le profil technique et les PV de la cible sont totalement remplacés."
    },
    {
        id: 75,
        nom: 'Métamorphose suprême',
        classe: ['Barde'],
        niveau: 9,
        ecole: 'Transmutation',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 1 heure",
        description: "Transforme une créature en une autre créature, une créature en un objet, ou un objet en créature. Si la concentration est maintenue pendant toute la durée, la transformation devient permanente jusqu'à dissipation."
    },
    {
        id: 76,
        nom: 'Aide',
        ...
        duree: '8 heures',
        description: "Le sort renforce vos alliés, qui deviennent plus robustes et plus résolus. Choisissez jusqu'à trois créatures à portée. Le maximum de points de vie et les points de vie actuels de chacune d'entre elles augmentent de 5 pendant toute la durée du sort. À plus haut niveau. Quand vous lancez ce sort en utilisant un emplacement de niveau 3 ou supérieur, les points de vie de chaque cible augmentent de 5 points supplémentaires pour chaque niveau au-delà du niveau 2."
    },
    {
        id: 77,
        nom: 'Allié planaire',
    ...
    },
    {
        ...
        composantes: "V, S, M (des poils ou des plumes venant d'un animal)",
        duree: "Concentration, jusqu'à 1 heure",
        description: "Vous touchez une créature pour lui accorder une amélioration magique. Choisissez l'un des effets suivants, dont la cible bénéficiera jusqu'à la fin du sort : Endurance de l'ours (avantage aux tests de Con, 2d6 PV temporaires), Force du taureau (avantage aux tests de For, capacité de charge doublée), Grâce du chat (avantage aux tests de Dex, pas de dégâts de chute de 6m ou moins si non neutralisée), Splendeur de l'aigle (avantage aux tests de Cha), Ruse du renard (avantage aux tests d'Int), Sagesse du hibou (avantage aux tests de Sag). À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 3 ou supérieur, vous pouvez prendre une créature de plus pour cible par niveau au-delà du niveau 2."
    },
    {
        id: 79,
        ...
        duree: 'Instantanée',
        description: "Ce sort crée un serviteur mort-vivant. Choisissez un tas d'os ou le cadavre d'un humanoïde de taille M ou P situé à portée. Le sort le relève sous forme de squelette (tas d'os) ou de zombi (cadavre). À chacun de vos tours, vous pouvez utiliser une action bonus pour donner un ordre mental aux créatures sous votre contrôle si elles se trouvent dans un rayon de 18 mètres. La créature est sous votre contrôle pendant 24 heures. Pour la contrôler pendant 24 heures de plus, relancez ce sort sur elle avant la fin de ce délai (permet de réaffirmer le contrôle sur un maximum de 4 créatures). À plus haut niveau. Avec un emplacement de niveau 4 ou supérieur, vous animez ou réaffirmez le contrôle sur deux créatures de plus par niveau au-delà du niveau 3."
    },
    {
        id: 80,
        nom: 'Apaisement des émotions',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous tentez de supprimer les émotions fortes au sein d'un groupe. Chaque humanoïde dans une sphère de 6 mètres de rayon centrée sur un point à portée doit réussir un JS de Charisme (possibilité de rater volontairement). En cas d'échec, vous choisissez l'un des effets suivants : supprimer temporairement tout état charmé ou terrorisé, ou rendre la cible indifférente vis-à-vis des créatures de votre choix envers lesquelles elle était hostile (prend fin si elle est attaquée/affectée par un sort néfaste)."
    },
    {
        id: 81,
        ...
        niveau: 2,
        ecole: 'Évocation',
        temps: '1 action bonus',
        portee: '18 mètres',
        composantes: 'V, S',
        duree: '1 minute',
        description: "Vous créez à portée une arme spectrale flottante. Lors de l'incantation, vous pouvez faire une attaque de sort au corps-à-corps contre une créature située dans un rayon de 1,50 mètre autour de l'arme (1d8 + modificateur de caractéristique d'incantation dégâts de force). À votre tour, via une action bonus, vous pouvez déplacer l'arme de 6 mètres maximum et répéter l'attaque. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 3 ou supérieur, les dégâts augmentent de 1d8 tous les 2 niveaux au-delà du niveau 2."
    },
    {
        id: 82,
        nom: 'Assistance',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: 'Vous touchez une créature consentante. Une fois avant la fin du sort, la cible peut lancer 1d4 et ajouter le résultat obtenu au test de caractéristique de son choix (avant ou après le test). Le sort se termine alors.'
    },
    {
        id: 83,
        nom: 'Augure',
        ...
        duree: 'Instantanée',
        description: "Vous utilisez un moyen de divination pour recevoir un présage concernant les 30 prochaines minutes : Bonheur, Malheur, Bonheur et malheur, ou Rien. Si vous lancez ce sort deux fois ou plus avant un long repos, il y a 25% de chances par incantation en sus de la première d'obtenir une prémonition aléatoire."
    },
    {
        id: 84,
        nom: 'Aura sacrée',
        ...
        temps: '1 action',
        portee: 'Personnelle',
        composantes: "V, S, M (un petit reliquaire d'une valeur minimum de 1000 po contenant une relique sacrée)",
        duree: "Concentration, jusqu'à 1 minute",
        description: "Une lumière divine émane de vous dans un rayon de 9 mètres. Les créatures choisies émettent une faible lumière (1,50 m), bénéficient de l'avantage aux JS, et les attaques contre elles subissent un désavantage. Quand un fiélon ou mort-vivant touche une cible affectée au corps-à-corps, l'assaillant doit réussir un JS de Constitution ou être aveuglé jusqu'à la fin du sort."
    },
    {
        id: 85,
        nom: 'Balisage',
        ...
        composantes: 'V, S',
        duree: '1 round',
        description: "Attaque de sort à distance contre une créature. En cas de réussite, elle subit 4d6 dégâts radiants et scintille jusqu'à la fin de votre prochain tour, accordant un avantage au prochain jet d'attaque contre elle. À plus haut niveau. +1d6 dégâts par niveau au-delà du niveau 1."
    },
    {
        id: 86,
        nom: 'Bannissement',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Une créature doit réussir un JS de Charisme ou être bannie. Si elle est native du plan actuel, elle est exilée dans un demi-plan inoffensif (neutralisée) et revient à la fin du sort. Si elle provient d'un autre plan, elle est renvoyée sur son plan natal (définitif si le sort dure 1 minute complète). À plus haut niveau. Visera +1 créature par niveau au-delà du niveau 4."
    },
    {
        id: 87,
        nom: 'Barrière de lames',
        classe: ['Clerc'],
        niveau: 6,
        ecole: 'Évocation',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 10 minutes",
        description: 'Crée un mur vertical de lames magiques (droit : 30m long x 6m haut x 1,5m épais ; ou circulaire : 18m diamètre x 6m haut x 1,5m épais). Offre un abri important et constitue un terrain difficile. Toute créature qui y pénètre ou y commence son tour doit réussir un JS de Dextérité sous peine de subir 6d10 dégâts tranchants (moitié si réussi).'
    },
    {
        id: 88,
        nom: 'Bénédiction',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Bénit jusqu'à trois créatures à portée. Chaque cible ajoute 1d4 à ses jets d'attaque et jets de sauvegarde. À plus haut niveau. Affecte +1 créature par niveau au-delà du niveau 1."
    },
    {
        id: 89,
        nom: 'Blessure',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: 'Attaque de sort au corps-à-corps. En cas de touche, inflige 3d10 dégâts nécrotiques. À plus haut niveau. +1d10 dégâts par niveau au-delà du niveau 1.'
    },
    {
        id: 90,
        ...
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Un champ scintillant confère un bonus de +2 à la CA d'une créature choisie à portée."
    },
    {
        id: 91,
        nom: 'Catalepsie',
        ...
        composantes: 'V, S, M (un petit morceau de linceul)',
        duree: '1 heure',
        description: "Plonge une créature vivante consentante dans un état cataleptique la faisant passer pour morte (aveuglée, inconsciente, immobile). À plus haut niveau. Augmente la durée (jusqu'à 1 siècle au niveau 9) mais inflige des niveaux d'épuisement au réveil."
    },
    {
        id: 92,
        nom: 'Cécité/Surdité',
        ...
        composantes: 'V',
        duree: '1 minute',
        description: 'Rend une cible aveugle ou sourde si elle échoue à un JS de Constitution. Elle peut retenter le JS à la fin de chacun de ses tours. À plus haut niveau. Visera +1 créature par niveau au-delà du niveau 2.'
    },
    {
        id: 93,
        nom: 'Cercle magique',
        ...
        temps: '1 minute',
        portee: '3 mètres',
        composantes: "V, S, M (eau bénite ou poudre d'argent et de fer d'une valeur minimale de 100 po, consommée)",
        duree: '1 heure',
        description: 'Crée un cylindre de 3m de rayon et 6m de haut bloquant ou protégeant contre un type de créature (célestes, élémentaires, fées, fiélons, morts-vivants). Les cibles choisies ont un désavantage aux attaques et ne peuvent charmer/terroriser/posséder. À plus haut niveau. +1 heure par niveau au-delà du niveau 3.'
    },
    {
        id: 94,
        nom: 'Champ antimagie',
        ...
        duree: "Concentration, jusqu'à 1 heure",
        description: "Une sphère d'antimagie de 3 mètres de rayon vous entoure. Au sein de la zone, il est impossible de lancer des sorts, les créatures invoquées disparaissent et les objets magiques deviennent ordinaires (hors artefacts et divinités)."
    },
    {
        id: 95,
        nom: 'Changement de plan',
        classe: ['Clerc'],
        niveau: 7,
        ecole: 'Invocation',
        temps: '1 action',
        portee: 'Contact',
        composantes: "V, S, M (un diapason de métal valant au moins 250 po, harmonisé avec un plan d'existence)",
        duree: 'Instantanée',
        description: "Transporte jusqu'à 8 créatures consentantes se tenant la main vers un autre plan d'existence. Peut aussi être utilisé offensivement contre une cible non consentante (attaque de sort au corps-à-corps puis JS Charisme)."
    },
    {
        id: 96,
        nom: 'Clairvoyance',
        ...
        temps: '10 minutes',
        portee: '1,5 kilomètre',
        composantes: 'V, S, M (focaliseur de 100 po : corne incrustée de pierreries ou œil de verre)',
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Crée un organe sensoriel invisible à un endroit familier ou évident. Vous permet de voir ou d'entendre à travers lui depuis cet endroit."
    },
    {
        id: 97,
        nom: 'Coercition mystique',
        ...
        composantes: 'V',
        duree: '30 jours',
        description: "Impose un ordre/service à une créature. Si elle comprend votre langue, elle doit réussir un JS de Sagesse ou être charmée. Elle subit 5d10 dégâts psychiques si elle agit à l'encontre des instructions (max 1/jour). Pas d'ordre suicidaire. À plus haut niveau. Durée de 1 an (niveau 7-8) ou permanente jusqu'à dissipation (niveau 9)."
    },
    {
        id: 98,
        nom: 'Colonne de flamme',
        classe: ['Clerc'],
        niveau: 5,
        ecole: 'Évocation',
        temps: '1 action',
        ...
        duree: 'Instantanée',
        description: 'Colonne de feu divin (cylindre de 3m de rayon, 12m de haut). Les créatures affectées font un JS de Dextérité et subissent 4d6 dégâts de feu et 4d6 dégâts radiants (moitié en cas de réussite). À plus haut niveau. +1d6 feu ou radiant par niveau au-delà du niveau 5.'
    },
    {
        id: 99,
        nom: 'Communication avec les morts',
        ...
        composantes: 'V, S, M (encens incandescent)',
        duree: '10 minutes',
        description: "Accorde un semblant de vie à un cadavre (non mort-vivant) ayant encore une bouche pour lui poser jusqu'à 5 questions. Les connaissances sont limitées à ce qu'il savait de son vivant."
    },
    {
        id: 100,
        nom: 'Communion',
        ...
        duree: '1 minute',
        description: "Entrez en contact avec votre divinité et posez jusqu'à trois questions fermées (oui/non)."
    },
    {
        id: 101,
        nom: 'Contagion',
        ...
        composantes: 'V, S',
        duree: '7 jours',
        description: "Attaque de sort au corps-à-corps pour inoculer une maladie (Bouille-crâne, Convulsions, Fièvre répugnante, Mal aveuglant, Mort poisseuse, Pourriture). La cible effectue des JS de Constitution à la fin de ses tours jusqu'à accumuler 3 réussites (guérison) ou 3 échecs (maladie active pendant 7 jours)."
    },
    {
        id: 102,
        nom: 'Contamination',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: 'Transmet une maladie virulente. JS de Constitution pour la cible : échec = 14d6 dégâts nécrotiques et réduction du maximum de PV pendant 1h du même montant ; réussite = moitié des dégâts et pas de réduction de PV max.'
    },
    {
        id: 103,
        ...
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Contrôle une étendue d'eau dans un cube de 30m d'arête. Permet d'Écarter les eaux, de provoquer une Inondation, de Modifier le cours de l'eau ou de créer un Tourbillon (2d8 dégâts contondants sur échec au JS)."
    },
    {
        id: 104,
        nom: 'Contrôle du climat',
        classe: ['Clerc'],
        niveau: 8,
        ecole: 'Transmutation',
        temps: '10 minutes',
        ...
        description: 'Permet de modifier les conditions météorologiques (précipitations, température, vent) dans un rayon de 7,5 km en extérieur.'
    },
    {
        id: 105,
        nom: 'Création de mort-vivant',
        classe: ['Clerc'],
        niveau: 6,
        ecole: 'Nécromancie',
        temps: '1 minute',
        portee: '3 mètres',
        composantes: "V, S, M (pot de poussière tombale, pot d'eau saumâtre et onyx noir de 150 po par cadavre)",
        duree: 'Instantanée',
        description: "Lancé de nuit, transforme jusqu'à 3 cadavres humanoïdes en goules sous votre contrôle pendant 24h. À plus haut niveau. Permet de créer/contrôler plus de goules ou des créatures plus puissantes (blêmes, nécrophages, momies)."
    },
    {
        id: 106,
        nom: "Création de nourriture et d'eau",
        classe: ['Clerc'],
        niveau: 3,
        ecole: 'Invocation',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "Crée 25 kg de nourriture et 120 litres d'eau (de quoi nourrir 15 humanoïdes ou 5 montures pendant 24 heures)."
    },
    {
        id: 107,
        nom: "Création ou destruction d'eau",
        classe: ['Clerc'],
        niveau: 1,
        ecole: 'Transmutation',
        temps: '1 action',
        portee: '9 mètres',
        composantes: "V, S, M (une goutte d'eau pour créer / quelques grains de sable pour détruire)",
        duree: 'Instantanée',
        description: "Crée ou détruit 40 litres d'eau (ou fait tomber une pluie / dissipe le brouillard dans un cube de 9m d'arête). À plus haut niveau. +40 litres ou +1,50m d'arête par niveau au-delà du niveau 1."
    },
    {
        id: 108,
        nom: 'Détection de la magie',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Perçoit la présence de magie dans un rayon de 9 mètres et permet d'en discerner l'école."
    },
    {
        id: 109,
        nom: 'Détection du mal et du bien',
        classe: ['Clerc'],
        niveau: 1,
        ecole: 'Divination',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 10 minutes",
        description: 'Détecte les aberrations, célestes, élémentaires, fées, fiélons ou morts-vivants à 9 mètres, ainsi que les lieux/objets consacrés ou profanés.'
    },
    {
        id: 110,
        nom: 'Détection du poison et des maladies',
        classe: ['Clerc'],
        niveau: 1,
        ecole: 'Divination',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 10 minutes",
        description: 'Perçoit les poisons, créatures venimeuses et maladies dans un rayon de 9 mètres et permet de les identifier.'
    },
    {
        id: 111,
        nom: 'Dissipation de la magie',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "Mets fin aux sorts de niveau 3 ou inférieur sur une cible. Test de caractéristique nécessaire pour les sorts de niveau supérieur (DD 10 + niveau du sort). À plus haut niveau. Dissipe automatiquement les sorts d'un niveau inférieur ou égal à l'emplacement utilisé."
    },
    {
        id: 112,
        nom: 'Dissipation du mal et du bien',
        classe: ['Clerc'],
        niveau: 5,
        ecole: 'Abjuration',
        temps: '1 action',
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Impose un désavantage aux attaques des fées, morts-vivants et créatures extraplanaires contre vous. Permet aussi d'annuler un enchantement (charme/terreur/possession) ou de tenter le renvoi d'une créature sur son plan d'origine."
    },
    {
        id: 113,
        nom: 'Divination',
        ...
        temps: '1 action',
        portee: 'Personnelle',
        composantes: "V, S, M (encens et offrande sacrificielle d'au moins 25 po, consommés)",
        duree: 'Instantanée',
        description: 'Pose une question sur un événement devant se dérouler dans les 7 jours pour obtenir une réponse sincère.'
    },
    {
        id: 114,
        nom: 'Doux repos',
        ...
        temps: '1 action',
        portee: 'Contact',
        composantes: 'V, S, M (une pincée de sel et une pièce de cuivre par œil du cadavre)',
        duree: '10 jours',
        description: 'Protège un cadavre contre la décomposition et la transformation en mort-vivant, et prolonge la limite de temps pour le rappeler à la vie.'
    },
    {
        id: 115,
        nom: 'Entrave planaire',
        ...
        temps: '1 heure',
        portee: '18 mètres',
        composantes: "V, S, M (un bijou d'une valeur minimale de 1000 po, consommé)",
        duree: '24 heures',
        description: "Lie un céleste, élémentaire, fée ou fiélon à votre service après un JS de Charisme raté de sa part. À plus haut niveau. Durée augmentée jusqu'à 1 an et 1 jour au niveau 9."
    },
    {
        id: 116,
        nom: 'Envoi de message',
        ...
        composantes: 'V, S, M (un petit bout de fil de cuivre)',
        duree: '1 round',
        description: 'Envoie un message de 25 mots maximum à une créature connue qui peut y répondre immédiatement.'
    },
    {
        id: 117,
        nom: 'Épargner les mourants',
        classe: ['Clerc'],
        niveau: 0,
        ecole: 'Nécromancie',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: 'Stabilise une créature vivante située à 0 point de vie.'
    },
    {
        id: 118,
        nom: 'Esprits gardiens',
        classe: ['Clerc'],
        niveau: 3,
        ecole: 'Invocation',
        temps: '1 action',
        portee: 'Personnelle (4,5 mètres de rayon)',
        composantes: 'V, S, M (un symbole sacré)',
        duree: "Concentration, jusqu'à 10 minutes",
        description: 'Des esprits vous entourent (4,5m). Réduit la vitesse des ennemis affectés et inflige 3d8 dégâts radiants (Bon/Neutre) ou nécrotiques (Mauvais) sur échec au JS de Sagesse. À plus haut niveau. +1d8 dégâts par niveau au-delà du niveau 3.'
    },
    {
        id: 119,
        nom: 'Façonnage de la pierre',
        classe: ['Clerc'],
        niveau: 4,
        ecole: 'Transmutation',
        temps: '1 action',
        portee: 'Contact',
        composantes: 'V, S, M (argile molle)',
        duree: 'Instantanée',
        description: "Modifie la forme d'un objet de pierre de taille M ou d'un volume de 1,50m de côté selon votre désir."
    },
    {
        id: 120,
        nom: 'Festin des héros',
        classe: ['Clerc'],
        niveau: 6,
        ecole: 'Invocation',
        temps: '10 minutes',
        portee: '9 mètres',
        composantes: "V, S, M (un bol incrusté de gemmes d'une valeur minimale de 1000 po, consommé)",
        duree: 'Instantanée',
        description: 'Matérialise un festin pour 12 créatures max (1h pour le consommer). Guérit maladies/poisons, donne immunité poison et terreur, avantage aux JS Sagesse et augmente le PV max de 2d10 pendant 24h.'
    },
    {
        id: 121,
        ...
        temps: '1 action',
        portee: 'Contact',
        composantes: "V, S, M (poussière de rubis d'une valeur de 50 po, consommée)",
        duree: "Jusqu'à dissipation",
        description: "Crée une flamme magique lumineuse sur un objet sans dégager de chaleur ni consommer d'oxygène."
    },
    {
        id: 122,
        nom: 'Flamme sacrée',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "Une lumière s'abat sur une cible (JS Dextérité sans bénéfice d'abri) pour infliger 1d8 dégâts radiants (+1d8 aux niveaux 5, 11 et 17)."
    },
    {
        id: 123,
        nom: 'Fléau',
        ...
        composantes: 'V, S, M (une goutte de sang)',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Jusqu'à 3 cibles doivent réussir un JS de Charisme ou soustraire 1d4 à leurs jets d'attaque et de sauvegarde. À plus haut niveau. Visera +1 créature par niveau au-delà du niveau 1."
    },
    {
        id: 124,
        nom: "Fléau d'insectes",
        classe: ['Clerc'],
        niveau: 5,
        ecole: 'Invocation',
        temps: '1 action',
        portee: '90 mètres',
        composantes: 'V, S, M (sucre en poudre, graines de céréales et une tache de graisse)',
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Sphère de 6m de rayon d'insectes carnivores (terrain difficile, visibilité réduite). Inflige 4d10 dégâts perforants sur échec au JS de Constitution. À plus haut niveau. +1d10 dégâts par niveau au-delà du niveau 5."
    },
    {
        id: 125,
        nom: 'Forme éthérée',
        ...
        composantes: 'V, S',
        duree: "Jusqu'à 8 heures",
        description: "Permet d'entrer dans le plan éthéré pour se déplacer à travers les objets et interagir uniquement avec ce plan. À plus haut niveau. Affecte jusqu'à 3 créatures supplémentaires par niveau au-delà du niveau 7."
    },
    {
        id: 126,
        nom: 'Fusion dans la pierre',
        classe: ['Clerc'],
        niveau: 3,
        ecole: 'Transmutation',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: '8 heures',
        description: 'Vous permet de fusionner votre corps et votre équipement dans un bloc de pierre.'
    },
    {
        id: 127,
        nom: 'Gardien de la foi',
        classe: ['Clerc'],
        niveau: 4,
        ecole: 'Invocation',
        temps: '1 action',
        ...
        composantes: 'V',
        duree: '8 heures',
        description: 'Invoque un gardien spectral. Les ennemis entrant à 3 mètres subissent 20 dégâts radiants sur échec au JS de Dextérité (moitié si réussi). Disparaît après avoir infligé 60 dégâts au total.'
    },
    {
        id: 128,
        nom: 'Glyphe de protection',
        ...
        temps: '1 heure',
        portee: 'Contact',
        composantes: "V, S, M (encens et poudre de diamant d'une valeur minimale de 200 po, consommés)",
        duree: "Jusqu'à dissipation ou déclenchement",
        description: "Inscrit un glyphe piège (Runes explosives : 5d8 dégâts dans une sphère de 6m ; ou Glyphe à sort : stocke un sort de niveau 3 ou inférieur). À plus haut niveau. +1d8 dégâts aux runes ou stocke un sort de niveau équivalent à l'emplacement utilisé."
    },
    {
        id: 129,
        nom: 'Guérison',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: 'Rend 70 points de vie à une cible et annule les états aveuglé, assourdi ainsi que toutes les maladies. À plus haut niveau. +10 PV de soin par niveau au-delà du niveau 6.'
    },
    {
        id: 130,
        nom: 'Guérison de groupe',
        classe: ['Clerc'],
        niveau: 9,
        ecole: 'Évocation',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "Rend jusqu'à 700 points de vie, répartis entre plusieurs cibles à portée, et guérit leurs maladies, aveuglement et surdité."
    },
    {
        id: 131,
        nom: 'Immobiliser un humanoïde',
        ...
        composantes: 'V, S, M (un petit morceau de fer bien droit)',
        duree: "Concentration, jusqu'à 1 minute",
        description: 'Paralyse un humanoïde sur échec à un JS de Sagesse (nouveau JS à la fin de chaque tour). À plus haut niveau. Visera +1 humanoïde par niveau au-delà du niveau 2.'
    },
    {
        id: 132,
        nom: 'Injonction',
        ...
        composantes: 'V',
        duree: '1 round',
        description: "Donne un ordre d'un seul mot à une cible (JS Sagesse) qu'elle doit exécuter au prochain tour (ex: Approche, Arrête, Fuis, Lâche, Rampe). À plus haut niveau. Affecte +1 créature par niveau au-delà du niveau 1."
    },
    {
        id: 133,
        nom: 'Interdiction',
        ...
        temps: '10 minutes',
        portee: 'Contact',
        composantes: "V, S, M (eau bénite, encens et rubis en poudre d'une valeur de 1000 po)",
        duree: '1 jour',
        description: 'Bloque les déplacements magiques/planaires dans une zone de 60m x 9m au sol et inflige 5d10 dégâts radiants/nécrotiques aux types de créatures choisies.'
    },
    {
        id: 134,
        nom: 'Invoquer un céleste',
        classe: ['Clerc'],
        niveau: 7,
        ecole: 'Invocation',
        temps: '1 minute',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 heure",
        description: "Invoque un céleste d'un indice de dangerosité égal ou inférieur à 4 (ou 5 avec un emplacement de niveau 9)."
    },
    {
        id: 135,
        nom: 'Jeter une malédiction',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Maudit une cible (JS Sagesse) avec au choix : désavantage aux tests/JS d'une caractéristique, désavantage aux attaques contre vous, perte d'action sur JS rater, ou +1d8 dégâts nécrotiques reçus. À plus haut niveau. Durée augmentée (ne nécessite plus de concentration à partir du niveau 5)."
    },
    {
        id: 136,
        nom: 'Langues',
        ...
        composantes: 'V, M (un modèle réduit de ziggourat en argile)',
        duree: '1 heure',
        description: "Permet à la cible de comprendre toutes les langues parlées et d'être comprise par toute créature maîtrisant au moins une langue."
    },
    {
        id: 137,
        nom: 'Légende',
        ...
        temps: '10 minutes',
        portee: 'Personnelle',
        composantes: "V, S, M (encens de 250 po consommé, 4 bandelettes d'ivoire de 50 po chacune)",
        duree: 'Instantanée',
        description: 'Révèle un résumé des connaissances et récits légendaires sur une personne, un lieu ou un objet.'
    },
    {
        id: 138,
        nom: 'Lever une malédiction',
        classe: ['Clerc'],
        niveau: 3,
        ecole: 'Abjuration',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: 'Supprime toutes les malédictions affectant une personne ou un objet.'
    },
    {
        id: 139,
        nom: 'Liberté de mouvement',
        ...
        composantes: "V, S, M (un lien de cuir enroulé autour d'un bras)",
        duree: '1 heure',
        description: "Empêche les terrains difficiles, sorts et effets de réduire la vitesse de la cible ou d'infliger l'état paralysé ou entravé."
    },
    {
        id: 140,
        nom: 'Lien de protection',
        classe: ['Clerc'],
        niveau: 2,
        ecole: 'Abjuration',
        temps: '1 action',
        portee: 'Contact',
        composantes: "V, S, M (une paire d'anneaux de platine valant chacun au moins 50 po)",
        duree: '1 heure',
        description: "Accorde à un allié à 18m ou moins +1 CA, +1 aux JS et résistance à tous les dégâts, mais vous subissez une quantité de dégâts identique à ceux qu'il reçoit."
    },
    {
        id: 141,
        nom: 'Localiser un objet',
        ...
        composantes: 'V, S, M (une branche fourchue)',
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Indique la direction d'un objet spécifique ou générique situé dans un rayon de 300 mètres."
    },
    {
        id: 142,
        nom: 'Localiser une créature',
        ...
        composantes: 'V, S, M (des poils de chien de chasse)',
        duree: "Concentration, jusqu'à 1 heure",
        description: "Indique la direction d'une créature spécifique ou de l'espèce la plus proche situées à 300 mètres ou moins."
    },
    {
        id: 143,
        nom: "Lueur d'espoir",
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Accorde aux cibles l'avantage aux JS de Sagesse, aux JS contre la mort, et garantit le maximum de soins reçus."
    },
    {
        id: 144,
        nom: 'Lumière',
        ...
        composantes: 'V, M (une luciole ou de la mousse phosphorescente)',
        duree: '1 heure',
        description: 'Fait émettre à un objet une lumière vive sur 6m et une lumière faible sur 6m supplémentaires.'
    },
    {
        id: 145,
        nom: 'Lumière du jour',
        ...
        composantes: 'V, S',
        duree: '1 heure',
        description: 'Crée une sphère de lumière vive de 18m de rayon (et 18m de lumière faible supplémentaires) dissipant les ténèbres magiques de niveau 3 ou inférieur.'
    },
    {
        id: 146,
        ...
        duree: '1 heure',
        description: "Permet jusqu'à 10 créatures consentantes de marcher sur des surfaces liquides comme s'il s'agissait d'un sol ferme."
    },
    {
        id: 147,
        nom: 'Mot de guérison',
        ...
        composantes: 'V',
        duree: 'Instantanée',
        description: "Rend 1d4 + modificateur de caractéristique d'incantation points de vie à une cible à portée. À plus haut niveau. +1d4 soins par niveau au-delà du niveau 1."
    },
    {
        id: 148,
        nom: 'Mot de guérison de groupe',
        classe: ['Clerc'],
        niveau: 3,
        ecole: 'Évocation',
        temps: '1 action bonus',
        ...
        composantes: 'V',
        duree: 'Instantanée',
        description: "Rend 1d4 + modificateur de caractéristique d'incantation points de vie à plusieurs cibles situées à portée."
    },
    {
        id: 149,
        nom: 'Mot de retour',
    ...
    },
    {
        ...
        composantes: 'V',
        duree: 'Instantanée',
        description: 'Vous prononcez une parole divine, empreinte de la puissance qui a façonné le monde à l’aube de la création. Choisissez autant de créatures situées à portée et dans votre champ de vision que vous le désirez. Chacune de celles qui vous entendent doit réussir un jet de sauvegarde de Charisme, ou souffrir d’un des effets suivants, selon son total actuel de points de vie. • 50 points de vie ou moins : assourdie pour 1 minute. • 40 points de vie ou moins : aveuglée et assourdie pour 10 minutes. • 30 points de vie ou moins : aveuglée, assourdie et étourdie pour 1 heure. • 20 points de vie ou moins : morte sur-le-champ. Quels que soient ses points de vie, si un céleste, un élémentaire, une fée ou un fiélon rate son jet de sauvegarde, il est immédiatement renvoyé sur son plan natal (s’il ne s’y trouve pas déjà). Il ne peut pas revenir sur votre propre plan pendant les 24 heures qui suivent, à moins d’user d’un souhait.'
    },
    {
        id: 151,
        nom: 'Portail',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: '8 heures',
        description: 'Vous touchez une créature et lui donnez une protection relative contre la mort. Quand elle devrait tomber à 0 point de vie pour la première fois suite à des dégâts, elle tombe à la place à 1 point de vie et le sort se termine. Si le sort est encore actif quand la cible est soumise à un effet qui devrait la tuer sur-le-champ sans lui infliger de dégâts, l’effet est annulé contre cette cible et le sort se termine.'
    },
    {
        id: 155,
        nom: 'Protection contre le mal et le bien',
        classe: ['Clerc'],
        niveau: 1,
        ecole: 'Abjuration',
        temps: '1 action',
    ...
    {
        id: 156,
        nom: 'Protection contre le poison',
        classe: ['Clerc', 'Druide'],
        niveau: 2,
        ecole: 'Abjuration',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: '1 heure',
        description: 'Vous touchez une créature. Si elle est empoisonnée, vous neutralisez ce poison. Si elle est victime de plusieurs poisons, vous en neutralisez un dont vous avez détecté la présence ou un au hasard. Pendant toute la durée du sort, la cible bénéficie d’un avantage lors des jets de sauvegarde contre le poison et se montre résistante aux dégâts de poison.'
    },
    {
        id: 157,
        nom: 'Protection contre les énergies',
        classe: ['Clerc', 'Druide'],
        niveau: 3,
        ecole: 'Abjuration',
        temps: '1 action',
    ...
    {
        id: 158,
        nom: 'Purification de la nourriture et de l’eau',
        classe: ['Clerc', 'Druide'],
        niveau: 1,
        ecole: 'Transmutation',
        temps: '1 action',
    ...
    },
    {
        ...
        duree: '1 heure',
        description: 'Vous touchez une créature et stimulez ses capacités de guérison naturelle. La cible récupère 4d8+15 points de vie. Pendant toute la durée du sort, elle récupère en plus 1 point de vie au début de chacun de ses tours (c’est-à-dire 10 points de vie par minute). Si la cible a des membres sectionnés (des doigts, des jambes, une queue, etc.), ils repoussent au bout de 2 minutes. Si vous disposez de la partie amputée et la maintenez contre le moignon, le sort ressoude instantanément le membre au moignon.'
    },
    {
        id: 161,
        nom: 'Réparation',
    ...
    },
    {
        ...
        duree: 'Concentration, jusqu’à 1 minute',
        description: 'Vous touchez une créature consentante. Une fois avant la fin du sort, elle peut lancer 1d4 et ajouter le résultat obtenu à un unique jet de sauvegarde de son choix. Elle peut lancer le dé avant ou après avoir fait son jet de sauvegarde. Le sort se termine alors.'
    },
    {
        id: 163,
        nom: 'Restauration inférieure',
        classe: ['Clerc', 'Druide', 'Barde'],
        niveau: 2,
        ecole: 'Abjuration',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: 'Vous touchez une créature et mettez fin à une maladie ou à un état spécial qui l’affectait, parmi aveuglé, assourdi, paralysé ou empoisonné.'
    },
    {
        id: 164,
        nom: 'Restauration supérieure',
        classe: ['Clerc', 'Druide', 'Barde'],
        niveau: 5,
        ecole: 'Abjuration',
        temps: '1 action',
    ...
    },
    {
        ...
        duree: 'Jusqu’à dissipation',
        description: 'Vous touchez un point et imprégnez la zone qui l’entoure de puissance bénie (ou impie). Cette zone possède un rayon maximal de 18 mètres, sachant que le sort échoue si cette zone chevauche une autre zone déjà sous l’effet d’un sort de sanctification. La zone affectée est soumise aux effets suivants. Premièrement, les célestes, les élémentaires, les fées, les fiélons et les morts-vivants ne peuvent entrer dans la zone. Les créatures qui se trouvent dans la zone ne peuvent être charmées, terrorisées ou possédées par l’une de ces créatures. Une créature déjà charmée, terrorisée ou possédée par l’une de ces créatures ne l’est plus dès qu’elle pénètre dans la zone. Vous pouvez décider qu’un ou plusieurs des types de créatures mentionnés ne seront pas affectés par cet effet. Deuxièmement, vous pouvez apposer un effet supplémentaire sur la zone. Choisissez l’un des effets de la liste suivante ou optez pour un autre que propose votre MJ. Certains effets s’appliquent aux créatures de la zone. Dans ce cas, vous pouvez préciser s’ils affectent toutes les créatures, uniquement celles qui obéissent à une divinité ou à un chef particulier, ou seulement celles d’un type donné, comme les orcs ou les trolls. Quand une créature susceptible d’être affectée pénètre dans la zone d’effet du sort pour la première fois de son tour ou quand elle y commence son tour, elle peut effectuer un jet de sauvegarde de Charisme. Si elle le réussit, elle ignore l’effet supplémentaire jusqu’à ce qu’elle quitte la zone. Courage. Les créatures affectées ne peuvent être terrorisées tant qu’elles se trouvent dans la zone. Interférence extradimensionnelle. Les créatures affectées ne peuvent pas se déplacer ni voyager en usant de téléportation, ni de moyens extradimensionnels ou interplanaires. Langues. Les créatures affectées peuvent communiquer avec n’importe quelle créature de la zone, même si elles ne partagent pas le même langage. Lumière du jour. Une vive lumière emplit la zone. Les ténèbres magiques issues d’un sort de niveau inférieur à celui de l’emplacement que vous avez utilisé pour lancer sanctification ne peuvent étouffer cette lumière. Protection contres les énergies. Les créatures affectées situées dans la zone gagnent une résistance contre un type de dégâts de votre choix, à l’exception des dégâts contondants, perforants et tranchants. Repos éternel. Les cadavres inhumés dans la zone ne peuvent pas se changer en morts-vivants. Ténèbres. Les ténèbres s’abattent sur la zone. La lumière normale est incapable d’illuminer les lieux, tout comme les lumières magiques issues d’un sort de niveau inférieur à celui de l’emplacement que vous avez utilisé pour lancer sanctification. Vulnérabilité à l’énergie. Les créatures affectées situées dans la zone sont affligées d’une vulnérabilité à un type de dégâts de votre choix, à l’exception des dégâts contondants, perforants et tranchants. Silence. Aucun son n’émane de l’intérieur de la zone et aucun son ne peut y pénétrer. Terreur. Les créatures affectées sont terrorisées tant qu’elles se trouvent dans la zone.'
    },
    {
        id: 169,
        nom: 'Sanctuaire',
        ...
        duree: '1 minute',
        description: 'Vous protégez une créature à portée contre les attaques. Jusqu’à la fin du sort, toute créature qui vise la cible avec une attaque ou un sort néfaste doit d’abord effectuer un jet de sauvegarde de Sagesse. Si elle le rate, elle doit choisir une nouvelle cible, sans quoi l’attaque ou le sort est perdu. Ce sort ne protège pas la cible contre les effets de zone, comme l’explosion d’une boule de feu. Ce sort se termine si la créature protégée attaque ou lance un sort affectant une créature ennemie.'
    },
    {
        id: 170,
        nom: 'Scrutation',
        ...
        duree: 'Concentration, jusqu’à 10 minutes',
        description: 'Vous voyez et entendez une créature donnée de votre choix, à condition qu’elle se trouve sur le même plan d’existence que vous. La cible doit effectuer un jet de sauvegarde de Sagesse, modifié par le degré de connaissance que vous avez d’elle et le type de lien physique que vous avez établi avec elle. Si la cible sait que vous lancez ce sort, elle peut rater volontairement son jet de sauvegarde si elle veut que vous l’observiez. Connaissance : Modificateur du jet de sauvegarde Deuxième main (vous avez entendu parler de la cible) : +5 Première main (vous avez rencontré la cible) : 0 Familière (vous connaissez bien la cible) : -5 Lien : Modificateur du jet de sauvegarde Représentation ou portrait : -2 Possession ou vêtement : -4 Partie du corps, cheveux, ongles, etc. : -10 Si la cible réussit son jet de sauvegarde, elle n’est pas affectée et vous ne pouvez plus utiliser ce sort sur elle pendant 24 heures. Si elle rate son jet, le sort crée un organe sensoriel invisible dans un rayon de 3 mètres autour d’elle. Vous voyez et entendez à travers cet organe comme si vous vous trouviez à sa place. L’organe sensoriel se déplace avec la cible et reste dans un rayon de 3 mètres autour d’elle pendant toute la durée du sort. Une créature capable de voir les objets invisibles perçoit l’organe sensoriel comme un orbe lumineux de la taille de votre poing. Au lieu de prendre une créature pour cible, vous pouvez choisir un lieu que vous avez déjà vu. L’organe sensoriel apparaît alors à cet endroit et n’en bouge pas.'
    },
    {
        id: 171,
        nom: 'Silence',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: 'La créature que vous touchez récupère un nombre de points de vie égal à 1d8 + votre modificateur de caractéristique d’incantation. Ce sort n’a aucun effet sur les morts-vivants et les créatures artificielles. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, les soins augmentent de 1d8 par niveau au-delà du niveau 1.'
    },
    {
        id: 173,
        nom: 'Soin des blessures de groupe',
        classe: ['Clerc', 'Druide', 'Barde'],
        niveau: 5,
        ecole: 'Évocation',
        temps: '1 action',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: 'Vous touchez une créature consentante. Une fois avant la fin du sort, la cible peut lancer 1d4 et ajouter le résultat obtenu au test de caractéristique de son choix. Elle peut lancer le dé avant ou après le test. Le sort se termine alors.'
    },
    {
        id: 186,
        nom: 'Baies nourricières',
        classe: ['Druide'],
        niveau: 1,
        ecole: 'Transmutation',
        temps: '1 action',
        ...
        duree: 'Instantanée',
        description: "Un maximum de dix baies apparaissent dans votre main. Elles sont imprégnées de magie pendant une journée. Une créature peut utiliser son action pour manger une baie, ce qui lui rend 1 point de vie et la nourrit pour la journée.\nLes baies perdent leurs propriétés si personne ne les mange dans les 24 heures qui suivent l'incantation."
    },
    {
        id: 187,
        nom: 'Bouffée de poison',
        classe: ['Druide'],
        niveau: 0,
        ecole: 'Invocation',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "Vous tendez la main en direction d'une créature située à portée et dans votre champ de vision et projetez une bouffée de gaz toxique sortie de votre paume. La créature doit réussir un jet de sauvegarde de Constitution ou subir 1d12 dégâts de poison.\nLes dégâts du sort augmentent de 1d12 quand vous atteignez le niveau 5 (2d12), 11 (3d12) et 17 (4d12)."
    },
    {
        id: 188,
        nom: 'Bourrasque',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: '7 jours',
        description: "Votre simple contact transmet des maladies. Faites une attaque de sort au corps-à-corps contre une créature à portée. Si vous touchez, vous lui inoculez une maladie de votre choix, à sélectionner parmi celles décrites ci-dessous.\nLa cible doit effectuer un jet de sauvegarde de Constitution à la fin de chacun de ses tours. Une fois qu'elle en a raté trois, la maladie fait effet pendant toute la durée du sort et la créature n'a plus à faire de jet de sauvegarde. Si elle réussit trois jets de sauvegarde, elle guérit de sa maladie et le sort se termine.\nComme le sort déclenche une maladie naturelle chez la cible, tout effet qui guérit une maladie ou améliore ses symptômes s'applique.\nBouille-crâne. La créature a soudain l'esprit enfiévré. Elle souffre d'un désavantage lors des tests d'Intelligence et des jets de sauvegarde d'Intelligence. De plus, au combat, elle se comporte comme si elle était sous l'effet d'un sort de confusion.\nConvulsions. La créature est agitée de tremblements. Elle subit un désavantage lors des tests de Dextérité, des jets de sauvegarde de Dextérité et des jets d'attaque basés sur la Dextérité.\nFièvre répugnante. Une forte fièvre s'empare de la créature, qui est affectée par un désavantage lors des tests de Force, des jets de sauvegarde de Force et des jets d'attaque basés sur la Force.\nMal aveuglant. La créature est en proie à de violentes douleurs cérébrales et ses yeux deviennent d'un blanc laiteux. Elle subit un désavantage lors des tests de Sagesse et des jets de sauvegarde de Sagesse et elle est aveuglée.\nMort poisseuse. La créature est affligée de saignements incontrôlables. Elle souffre d'un désavantage lors des tests de Constitution et des jets de sauvegarde de Constitution. De plus, elle est étourdie jusqu'à la fin de son prochain tour à chaque fois qu'elle subit des dégâts.\nPourriture. La chair de la créature se met à pourrir. Elle subit un désavantage lors des tests de Charisme et devient vulnérable à tous les dégâts."
    },
    {
        id: 201,
        nom: "Contrôle de l'eau",
    ...
    {
        id: 233,
        nom: 'Invoquer des êtres des bois',
        classe: ['Druide'],
        niveau: 4,
        ecole: 'Invocation',
        temps: '1 action',
    ...
    },
    {
        ...
        duree: '1 heure',
        description: "Vous touchez une créature consentante. Pendant toute la durée du sort, ses déplacements ne sont pas affectés par un terrain difficile, tandis que les sorts et autres effets magiques ne peuvent ni réduire sa vitesse, ni provoquer l'état paralysé ou entravé.\nLa cible peut également dépenser 1,50 mètre de déplacement pour échapper automatiquement à des liens non magiques, comme des menottes ou la prise d'une créature qui l'empoigne.\nEnfin, sous l'eau, elle ne subit pas de malus aux déplacements ni aux attaques."
    },
    {
        id: 239,
        nom: 'Localiser des animaux ou des plantes',
    ...
    },
    {
        ...
        composantes: 'V',
        duree: 'Instantanée',
        description: "Une créature de votre choix située à portée et dans votre champ de vision récupère un nombre de points de vie égal à 1d4 + votre modificateur de caractéristique d'incantation. Ce sort n'a aucun effet sur les créatures artificielles et les morts-vivants.\nÀ plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, les soins augmentent de 1d4 par niveau au-delà du niveau 1."
    },
    {
        id: 250,
        nom: "Mur d'épines",
    ...
    },
    {
        ...
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Vous créez un mur de pierre non magique qui se matérialise en un point de votre choix à portée. Il fait 15 centimètres d'épaisseur et se compose de dix panneaux de 3 mètres sur 3. Chaque panneau doit être contigu à un autre. Sinon, vous pouvez opter pour des panneaux de 3 mètres sur 6."
    },
    {
        id: 253,
        nom: 'Agrandir/Rétrécir',
        classe: ['Ensorceleur'],
        niveau: 2,
        ecole: 'Transmutation',
        temps: '1 action',
    ...
    },
    {
        ...
        composantes: 'V, S, M (des poils ou des plumes venant d’un animal)',
        duree: 'concentration, jusqu’à 1 heure',
        description: 'Vous touchez une créature pour lui accorder une amélioration magique. Choisissez l’un des effets suivants, dont la cible bénéficiera jusqu’à la fin du sort. Endurance de l’ours. La cible a l’avantage lors des tests de Constitution. Elle gagne aussi 2d6 points de vie temporaires qui disparaissent quand le sort se termine. Force du taureau. La cible bénéficie d’un avantage lors des tests de Force et le poids qu’elle peut porter est doublé. Grâce du chat. La cible a l’avantage lors des tests de Dextérité. De plus, elle ne subit pas de dégât quand elle chute de 6 mètres ou moins, à condition qu’elle ne soit pas neutralisée. Splendeur de l’aigle. La cible bénéficie d’un avantage lors des tests de Charisme. Ruse du renard. La cible a l’avantage lors des tests d’Intelligence. Sagesse du hibou. La cible a l’avantage lors des tests de Sagesse. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 3 ou supérieur, vous pouvez prendre une créature de plus pour cible par niveau au-delà du niveau 2.'
    },
    {
        id: 255,
        nom: 'Animation des objets',
    ...
    },
    {
        ...
        composantes: 'V, S, M (un objet qui répugne à la cible)',
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Vous tentez d’envoyer une créature située dans votre champ de vision dans un autre plan d’existence. Elle doit réussir un jet de sauvegarde de Charisme ou être bannie. Si la cible est native du plan d’existence sur lequel vous vous trouvez, vous l’exilez dans un demi-plan inoffensif. Elle est neutralisée tant qu’elle se trouve là-bas et y reste jusqu’à la fin du sort. À ce moment, elle réapparaît à l’endroit qu’elle a quitté, ou dans l’emplacement inoccupé le plus proche si son emplacement de départ est occupé. Si la cible est originaire d’un plan d’existence autre que celui sur lequel vous vous trouvez, une légère détonation accompagne son retour contraint sur son plan d’origine. Si le sort se termine avant que 1 minute ne se soit écoulée, la cible réapparaît à l’endroit qu’elle a quitté, ou dans l’emplacement inoccupé le plus proche si son emplacement de départ est occupé. Sinon, elle ne revient pas. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 5 ou supérieur, vous pouvez viser une créature de plus par niveau au-delà du niveau 4.'
    },
    {
        id: 262,
        nom: 'Bouclier',
        ...
        niveau: 1,
        ecole: 'Abjuration',
        temps: '1 réaction à effectuer lorsque vous êtes touché par une attaque ou un sort de projectile magique',
        portee: 'personnelle',
        composantes: 'V, S',
        duree: '1 round',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'Instantannée',
        description: "Vous lancez une boule d'acide. Choisissez une créature à portée, ou deux créatures à portée situées à 1,50 mètre ou moins l'une de l'autre. Une cible doit réussir un jet de sauvegarde de Dextérité, sinon elle subit 1d6 dégâts d'acide.\n\nLes dégâts du sort augmentent de 1d6 quand vous atteignez le niveau 5 (2d6), 11 (3d6) et 17 (4d6)."
    },
    {
        id: 275,
        nom: 'Assassin imaginaire',
        classe: ['Magicien'],
        niveau: 4,
        ecole: 'Illusion',
        temps: '1 action',
    ...
    {
        id: 277,
        nom: "Aura magique de l'arcaniste",
        classe: ['Magicien'],
        niveau: 2,
        ecole: 'Illusion',
        temps: '1 action',
    ...
    {
        id: 284,
        nom: 'Boule de feu à explosion retardée',
        classe: ['Magicien'],
        niveau: 7,
        ecole: 'Évocation',
        temps: '1 action',
    ...
    },
    {
        ...
        duree: 'Instantannée',
        description: "Vous créez un arc électrique qui file vers une cible de votre choix, située à portée et dans votre champ de vision. Trois éclairs bondissent ensuite de cette cible sur un maximum de trois autres cibles qui doivent toutes se trouver dans un rayon de 9 mètres autour de la première. Une cible peut être une créature ou un objet et ne peut recevoir qu'un seul éclair.\n\nChaque cible doit faire un jet de sauvegarde de Dextérité et subit 10d8 dégâts de foudre en cas d'échec, la moitié en cas de réussite.\n\nÀ plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 7 ou supérieur, un éclair de plus rebondit de la première cible vers une autre pour chaque niveau au-delà du niveau 6."
    },
    {
        id: 295,
        nom: 'Champ antimagie',
    ...
    },
    {
        ...
        composantes: 'V, S, M (une pincée de suie et de sel)',
        duree: '1 heure',
        description: 'Pendant toute la durée du sort, vous comprenez le sens littéral de tout langage parlé que vous entendez. Vous comprenez aussi les langues écrites que vous voyez, à condition de toucher la surface sur laquelle les mots ont été tracés. Il vous faut 1 minute pour lire une page de texte.\n\nCe sort ne décode pas les messages secrets compris dans un texte ni les glyphes qui ne correspondent pas à un langage écrit, comme un symbole magique.'
    },
    {
        id: 306,
        nom: 'Cône de froid',
    ...
    },
    {
        ...
        composantes: "V, S, M (encens incandescent et un peu de bois et de terre mélangés dans de l'eau)",
        duree: "Concentration, jusqu'à 8 heures",
        description: "Vous prenez le contrôle de la météo dans un rayon de 7,5 kilomètres autour de vous pendant toute la durée du sort. Vous devez être en extérieur au moment de l'incantation. Si vous vous rendez dans un endroit d'où vous ne voyez pas directement le ciel, le sort se termine prématurément.\n\nAu moment de l'incantation, vous changez les conditions météorologiques actuelles déterminées par le MJ en fonction du climat et de la saison. Vous pouvez modifier les précipitations, la température et le vent. Il faut 1d4x10 minutes pour que les nouvelles conditions s'installent. Vous pouvez ensuite les modifier à nouveau. Le temps retourne progressivement à la normale une fois le sort terminé.\n\nQuand vous modifiez les conditions météorologiques, cherchez les conditions actuelles dans les tables suivantes : vous pouvez les décaler d'un cran vers le haut ou le bas. Quand vous modifiez le vent, vous pouvez changer sa direction.\n\nPrécipitations :\n1: Ciel dégagé\n2: Quelques nuages\n3: Ciel couvert ou brume au sol\n4: Pluie, grêle ou neige\n5: Pluies torrentielles, forte grêle ou blizzard\n\nTempérature :\n1: Chaleur insoutenable\n2: Forte chaleur\n3: Tiède\n4: Frais\n5: Grand froid\n6: Froid polaire\n\nVent :\n1: Temps calme\n2: Vent modéré\n3: Vent fort\n4: Grand vent\n5: Tempête"
    },
    {
        id: 314,
        nom: 'Convocations instantanées',
        classe: ['Magicien'],
        niveau: 6,
        ecole: 'Invocation',
        temps: '1 minute',
    ...
    },
    {
        ...
        composantes: 'V',
        duree: 'Concentration, jusqu’à 1 minute',
        description: 'Choisissez une créature située à portée et dans votre champ de vision. La cible entame une danse comique, se mettant à taper du pied et à caracoler sur place. Les créatures qui ne peuvent être charmées sont immunisées contre ce sort.\n\nUne fois que la créature s’est mise à danser, elle doit dépenser la totalité de son déplacement pour danser sans quitter son espace. De plus, elle souffre d’un désavantage lors des jets de sauvegarde de Dextérité et des jets d’attaque. Tant que la cible est affectée par ce sort, les autres créatures bénéficient d’un avantage lors de leurs jets d’attaque contre elle. Une créature en train de danser peut utiliser son action pour effectuer un jet de sauvegarde de Sagesse et reprendre le contrôle de son corps. Si elle réussit, le sort se termine.'
    },
    {
        id: 320,
        nom: 'Déblocage',
    ...
    },
    {
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous désignez une cible vivante à portée du sort et tant que vous vous concentrez, l'eau contenue dans son corps s'écoule par ses yeux, sa bouche, ses oreilles ou les pores de sa peau. Au début de chacun de ses tours, la cible doit réussir un jet de sauvegarde de Constitution ou subir 2d6 dégâts nécrotiques. Une sauvegarde réussie réduit ces dégâts de moitié.\n\nLes morts-vivants, les créatures artificielles et les élémentaires sont immunisés à ce sort.\n\nÀ plus haut niveau. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, vous pouvez affecter une cible supplémentaire par niveau d'emplacement au-delà du niveau 2."
    },
    {
        id: 326,
        nom: 'Détection de la magie',
    ...
    },
    {
        ...
        composantes: "V, S, M (un peu d'eau bénite à asperger)",
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous bénissez jusqu'à trois créatures de votre choix situées à portée. Quand une cible fait un jet d'attaque ou de sauvegarde avant la fin du sort, elle lance 1d4 et ajoute le résultat obtenu au jet d'attaque ou de sauvegarde.\nÀ plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, vous pouvez affecter une créature de plus par niveau au-delà du niveau 1."
    },
    {
        id: 334,
        nom: 'Bénédiction héroïque',
        classe: ['Paladin'],
        niveau: 3,
        ecole: 'Divination',
        temps: '1 action',
        ...
        composantes: 'V',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous désignez jusqu'à 5 créatures à portée et que vous pouvez voir. Les cibles et vous-même bénéficiez d'un avantage au jet d'attaque sur la première attaque de chacun de vos tours pour toute la durée du sort."
    },
    {
        id: 335,
        nom: 'Bouclier de la foi',
        ...
        composantes: 'V, S, M (un petit parchemin avec un extrait de texte sacré)',
        duree: "Concentration, jusqu'à 10 minutes",
        description: "Un champ scintillant apparaît autour d'une créature de votre choix située à portée et lui confère un bonus de +2 à la CA pendant toute la durée du sort."
    },
    {
        id: 336,
        nom: 'Brûlure du juste',
        classe: ['Paladin'],
        niveau: 1,
        ecole: 'Évocation',
        temps: '1 action',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: '1 minute',
        description: "Vous défiez un adversaire à portée. Tant que vous n'attaquez que cet adversaire, vous bénéficiez d'un avantage à votre première attaque à chacun de vos tours."
    },
    {
        id: 339,
        nom: 'Coercition mystique',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "Vous créez 25 kilogrammes de nourriture et 120 litres d'eau, soit par terre, soit dans des récipients installés à portée. Cela suffit à nourrir et abreuver un maximum de quinze humanoïdes ou de cinq montures pendant 24 heures. Les vivres sont fades mais nourrissants. Ils se gâtent si personne ne les a mangés dans les 24 heures suivant leur création. L'eau est claire et ne croupit pas."
    },
    {
        id: 341,
        nom: 'Détection de la magie',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous imprégnez de courage une créature consentante que vous touchez. Jusqu'à la fin du sort, elle est immunisée contre l'état terrorisé et, au début de chacun de ses tours, elle gagne un nombre de points de vie temporaires égal à votre modificateur de caractéristique d'incantation. Quand le sort se termine, la cible perd les éventuels points de vie temporaires restants issus de ce sort.\nÀ plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, vous pouvez affecter une créature de plus par niveau au-delà du niveau 1."
    },
    {
        id: 352,
        nom: 'Injonction',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'Instantanée',
        description: "À votre contact, toutes les malédictions qui affectent une créature ou un objet disparaissent. Si l'objet est un objet magique maudit, la malédiction persists, mais le sort rompt l'harmonisation entre l'objet et son détenteur, ce qui permet à ce dernier de l'ôter ou de s'en débarrasser."
    },
    {
        id: 356,
        nom: 'Localiser un objet',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: '8 heures',
        description: "Vous touchez une créature et lui donnez une protection relative contre la mort. Quand elle devrait tomber à 0 point de vie pour la première fois suite à des dégâts, elle tombe à la place à 1 point de vie et le sort se termine.\nSi le sort est encore actif quand la cible est soumise à un effet qui devrait la tuer sur-le-champ sans lui infliger de dégâts, l'effet est annulé contre cette cible et le sort se termine."
    },
    {
        id: 362,
        nom: 'Protection contre le mal et le bien',
    ...
    },
    {
        ...
        duree: '1 heure',
        description: "Vous créez un piège qui s'enroule autour d'un ou plusieurs membres de l'individu ciblé et peut le faire chuter ou le ligoter. Le piège affecte une zone de 3 mètres de rayon autour d'un point que vous désignez à portée. Cette zone doit être placée sur un terrain naturel (pas sur une route ni dans une structure artificielle). La première créature qui traverse la zone piégée doit faire un jet de sauvegarde de Dextérité. En cas de succès, elle est à terre, en cas d'échec elle est de plus entravée. Une créature à terre termine immédiatement son déplacement et perd l'action en cours. Elle peut se relever normalement avec sa prochaine action. Une créature entravée peut utiliser son action à chaque tour pour faire un nouveau jet de sauvegarde de Dextérité ou de Force au choix afin de se délivrer. Toutefois, à chaque fois qu'elle lutte pour échapper aux liens, ceux-ci se resserrent et lui infligent 1d6 dégâts tranchants. Tant qu'elle n'essaye pas de se délivrer, elle ne subit pas de dégât.\nÀ plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 3 ou supérieur, le sort affecte une cible supplémentaire par niveau au-delà du niveau 2."
    },
    {
        id: 377,
        nom: 'Communication avec les animaux',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous invoquez une liane mobile dotée de sarments flexibles et vous la contrôlez pendant toute la durée du sort. Sa vitesse de déplacement est de 1,50 mètre et son allonge est de 3 mètres. La liane se détend subitement lorsque qu'un adversaire passe à sa portée. La victime doit réussir un jet de sauvegarde de Force ou subir 1d6+7 dégâts contondants et être entravée. À son tour, la cible peut effectuer un jet de sauvegarde de Force pour se libérer en utilisant une action bonus. La liane a le profil suivant : CA 15, points de vie 30, Force 20 (+5), résistance au feu et au froid, immunité à la foudre."
    },
    {
        id: 389,
        nom: 'Liberté de mouvement',
    ...
    },
    {
        ...
        composantes: 'V, S, M (des poils de chien de chasse)',
        duree: 'Concentration, jusqu’à 1 heure',
        description: 'Décrivez ou nommez une créature qui vous est familière. Vous sentez dans quelle direction elle se trouve, à condition qu’elle soit dans un rayon de 300 mètres. Si elle se déplace, vous savez dans quelle direction.\nLe sort permet de localiser une créature spécifique de votre connaissance ou la créature la plus proche du même type (comme un humain ou une licorne), mais pour cela, vous devez avoir déjà vu une telle créature de près, c’est-à-dire vous être trouvé à moins de 9 mètres d’elle au moins une fois dans votre vie. Si la créature que vous décrivez ou nommez se trouve actuellement sous une forme différente, sous l’effet d’un sort de métamorphose, par exemple, ce sort est incapable de la localiser.\nLe sort ne parvient pas à localiser la créature si le chemin qui vous relie directement est coupé par une étendue d’eau courante d’au moins 3 mètres de wide.'
    },
    {
        id: 393,
        nom: 'Lumière du jour',
    ...
    },
    {
        ...
        composantes: 'V',
        duree: 'Concentration, jusqu’à 1 minute',
        description: 'Une arme de votre choix exsude une substance poisseuse et venimeuse. À la première attaque que vous réussissez avec cette arme, la victime doit réussir un jet de sauvegarde de Constitution ou subir 2d6 dégât de poison et être empoisonnée. En cas de succès, elle subit seulement la moitié des dégâts et elle n’est pas empoisonnée.\nÀ plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, les dégâts augmentent de 1d6 par niveau au-delà du niveau 1.'
    },
    {
        id: 407,
        nom: 'Projectile toxique',
        classe: ['Rôdeur'],
        niveau: 3,
        ecole: 'Invocation',
        temps: '1 action bonus',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'instantanée',
        description: "Vous tendez la main en direction d'une créature située à portée et dans votre champ de vision et projetez une bouffée de gaz toxique sortie de votre paume. La créature doit réussir un jet de sauvegarde de Constitution ou subir 1d12 dégâts de poison. Les dégâts du sort augmentent de 1d12 quand vous atteignez le niveau 5 (2d12), 11 (3d12) et 17 (4d12)."
    },
    {
        id: 422,
        nom: 'Briser',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: "concentration, jusqu'à 1 minute",
        description: "Le simple contact de votre main enveloppée d'ombres peut siphonner la force vitale d'autrui pour soigner vos propres plaies. Faites une attaque de sort au corps-à-corps contre une créature située à une distance inférieure ou égale à votre allonge. Si vous touchez, elle subit 3d6 dégâts nécrotiques et vous récupérez un total de points de vie égal à la moitié des dégâts infligés. Vous pouvez dépenser votre action à chacun de vos tours pour répéter cette attaque jusqu'à la fin du sort. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 4 ou supérieur, les dégâts augmentent de 1d6 par niveau au-delà du niveau 3."
    },
    {
        id: 425,
        nom: 'Cercle de mort',
    ...
    },
    {
        ...
        niveau: 3,
        ecole: 'Abjuration',
        temps: '1 réaction à utiliser quand vous voyez une créature située dans un rayon de 18 mètres autour de vous lancer un sort',
        portee: '18 mètres',
        composantes: 'S',
        duree: 'instantanée',
    ...
    },
    {
        ...
        composantes: "V, S, M (une goutte d'eau)",
        duree: "concentration, jusqu'à 1 minute",
        description: "Vous désignez une cible vivante à portée du sort et tant que vous vous concentrez, l'eau contenue dans son corps s'écoule par ses yeux, sa bouche, ses oreilles ou les pores de sa peau. Au début de chacun de ses tours, la cible doit réussir un jet de sauvegarde de Constitution ou subir 2d6 dégâts nécrotiques. Une sauvegarde réussie réduit ces dégâts de moitié. Les morts-vivants, les créatures artificielles et les élémentaires sont immunisés à ce sort. À plus haut niveau. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, vous pouvez affecter une cible supplémentaire par niveau d'emplacement au-delà du niveau 2."
    },
    {
        id: 437,
        nom: 'Dissipation de la magie',
        ...
        composantes: 'V, S',
        duree: 'instantanée',
        description: "Choisissez une créature, un objet ou un effet magique à portée. Tout sort de niveau 3 ou inférieur qui l'affecte se termine. Si la cible est affectée par un sort de niveau 4 ou plus, faites un test de caractéristique en utilisant votre caractéristique d'incantation. Le DD est de 10 + niveau du sort. Ce dernier se termine si vous réussissez votre test. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 4 ou supérieur, vous mettez automatiquement un terme à un sort affectant la cible quand le niveau de ce sort est égal ou inférieur au niveau de l'emplacement de sort que vous utilisez."
    },
    {
        id: 438,
        nom: 'Doigt de mort',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: "concentration, jusqu'à 1 heure",
        description: "Vous tentez d'envoûter une créature située à portée et dans votre champ de vision. Elle doit réussir un jet de sauvegarde de Sagesse, sans quoi elle est charmée par vous pendant toute la durée du sort. Elle dispose d'un avantage lors du jet de sauvegarde si vous ou des créatures amicales envers vous êtes en train de la combattre. Tant que la créature est charmée, vous entretenez un lien télépathique avec elle qui persiste tant que vous vous trouvez sur le même plan d'existence. Vous pouvez utiliser ce lien télépathique pour donner des ordres à cette créature tant que vous êtes conscient (ce qui ne vous demande pas d'action). Elle fait de son mieux pour vous obéir. Vous pouvez lui donner un ordre simple et générique, comme « attaque cette créature », « cours jusque là-bas » ou « va chercher cet objet ». Si elle ne reçoit pas de nouvelle instruction de votre part une fois l'ordre exécuté, elle se contente de se défendre et de se préserver au mieux. Vous pouvez utiliser votre action pour prendre le contrôle total de votre cible et la diriger de façon précise. Jusqu'à la fin de votre prochain tour, elle exécute seulement les actions que vous choisissez et ne fait rien que vous ne lui ayez autorisé. Pendant cette période, vous pouvez aussi lui faire exécuter une réaction, mais vous devez pour cela également dépenser votre propre réaction. À chaque fois que la cible subit des dégâts, elle a droit à un nouveau jet de sauvegarde de Sagesse contre le sort. Si elle le réussit, le sort prend fin. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 9, la durée devient « concentration, jusqu'à 8 heures »."
    },
    {
        id: 440,
        nom: 'Emprisonnement',
    ...
    },
    {
        ...
        composantes: 'V, S, M (une poignée de sphères en argile, en cristal, en verre ou minérales)',
        duree: 'instantanée',
        description: "Vous vous attaquez à l'esprit d'une créature située à portée et dans votre champ de vision en essayant de briser son intellect et sa personnalité. La cible subit 4d6 dégâts psychiques et doit effectuer un jet de sauvegarde d'Intelligence. Si la cible rate son jet, son Intelligence et son Charisme tombent à 1. Elle ne peut plus lancer de sort, activer d'objet magique, comprendre une langue ni communiquer de manière intelligible. En revanche, elle est toujours capable de reconnaître ses amis, de les suivre et même de les protéger. La créature peut refaire un jet de sauvegarde tous les 30 jours. Le sort se termine dès qu'elle réussit. On peut aussi mettre un terme à ce sort grâce à l'un des sorts suivants : restauration supérieure, guérison ou souhait."
    },
    {
        id: 443,
        nom: 'Explosion occulte',
        classe: ['Sorcier'],
        niveau: 0,
        ecole: 'Évocation',
        temps: '1 action',
    ...
    },
    {
        ...
        duree: 'instantanée',
        description: "Une explosion de flammes noires jaillit de votre corps et blesse les créatures située à moins de 1,50 mètre de vous. Chaque créature dans la zone doit réussir un jet de sauvegarde de Dextérité, ou subir 2d6 dégâts nécrotiques et être aveuglée jusqu'à votre prochain tour. En cas de réussite, elle ne subit que la moitié des dégâts et n'est pas aveuglée. À plus haut niveau. Lorsque vous lancez ce sort en utilisant un emplacement de sorts de niveau 2 ou supérieur, les dégâts augmentent de 1d6 pour chaque emplacement au-delà du niveau 1."
    },
    {
        id: 445,
        nom: 'Flétrissement',
    ...
    },
    {
        ...
        duree: "concentration, jusqu'à 1 heure",
        description: "Vous touchez une créature consentante et la transformez, ainsi que tous les objets qu'elle porte et qu'elle transporte, en nuage brumeux pour toute la durée du sort. Ce dernier se termine si la créature tombe à 0 point de vie. Le sort n'affecte pas les créatures intangibles. Sous cette forme, la cible n'a plus qu'un seul mode de déplacement: le vol, à une vitesse de 3 mètres. Elle peut entrer dans l'espace d'une autre créature et l'occuper. Elle est résistante aux dégâts non magiques et elle bénéficie d'un avantage lors des jets de sauvegarde de Force, de Dextérité et de Constitution. Elle peut passer à travers de petits trous, de minces ouvertures et même de simples fissures. En revanche, les liquides équivalent pour elle à des surfaces solides. Elle ne peut pas tomber et continue de flotter dans les airs même si elle est étourdie ou neutralisée. Sous forme de nuage brumeux, la cible ne peut pas parler ni manipuler d'objet. Il lui est impossible de lâcher les objets qu'elle portait et qu'elle transportait, et personne ne peut les utiliser ni interagir avec eux. Elle ne peut pas attaquer ni lancer de sort."
    },
    {
        id: 448,
        nom: 'Illusion mineure',
    ...
    },
    {
        ...
        composantes: 'V, S, M (un morceau de toison)',
        duree: "concentration, jusqu'à 10 minutes",
        description: "Vous créez l'image d'un objet, d'une créature ou d'un phénomène visible pas plus grand qu'un cube de 6 mètres d'arête. L'image apparaît en un point situé à portée et dans votre champ de vision et persists pendant toute la durée du sort. Elle a l'air absolument réelle et s'accompagne des sons, des odeurs et de la température appropriés pour la chose qu'elle représente. En revanche, elle ne dégage pas assez de chaleur ou de froid pour blesser quelqu'un, ne génère pas de son assez puissant pour provoquer des dégâts de tonnerre pour qu'une créature soit assourdie, et n'émet pas une odeur assez puissante pour écœuruer une créature (comme le fait la puanteur du troglodyte). Tant que vous êtes à portée de l'illusion, vous pouvez utiliser votre action pour déplacer l'image vers un autre point situé à portée. Quand l'image bouge, vous pouvez modifier son apparence de manière à ce que ses mouvements paraissent naturels. Les interactions physiques avec l'image révèlent qu'elle n'est qu'une illusion, car les objets la traversent. Si une créature utilise son action pour examiner l'image, elle comprend que c'est une illusion à condition de réussir un test d'Intelligence (Investigation) contre le DD du jet de sauvegarde de votre sort. Si une créature perce l'illusion à jour, elle voit à travers l'image et ne perçoit plus que faiblement ses autres propriétés sensorielles. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 6 ou supérieur, le sort persiste jusqu'à dissipation, sans que vous ayez besoin de vous concentrer."
    },
    {
        id: 450,
        nom: 'Image miroir',
    ...
    },
    {
        ...
        composantes: 'V, S, M (un petit morceau de fer bien droit)',
        duree: "concentration, jusqu'à 1 minute",
        description: 'Choisissez une créature située à portée et dans votre champ de vision. Elle doit réussir un jet de sauvegarde de Sagesse, sans quoi elle est paralysée pour toute la durée du sort. Ce sort est sans effet sur les morts-vivants. À la fin de chacun de ses tours, la cible a droit à un nouveau jet de sauvegarde de Sagesse. Si elle le réussit, le sort se termine. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 6 ou supérieur, vous pouvez viser une créature de plus par niveau au-delà du niveau 5. Les créatures visées doivent se trouver à 9 mètres ou moins les unes des autres au moment où vous lancez le sort.'
    },
    {
        id: 453,
        nom: 'Invisibilité',
        ...
        composantes: 'V, S, M (un cil enrobé de gomme arabique)',
        duree: "concentration, jusqu'à 1 heure",
        description: "La créature que vous touchez devient invisible jusqu'à la fin du sort. Tout ce qu'elle porte et transporte reste invisible tant qu'elle le garde sur elle. Le sort se termine si la cible attaque ou lance un sort. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 3 ou supérieur, vous pouvez viser une créature de plus par niveau au-delà du niveau 2."
    },
    {
        id: 454,
        nom: 'Invoquer une fée',
    ...
    },
    {
        ...
        duree: '8 heures',
        description: "Vous vous recouvrez d'une enveloppe de givre. Vous bénéficiez d'une résistance aux dégâts contre la prochaine attaque réussie contre vous, tandis que la créature qui vous a attaqué subit la moitié des dégâts de son attaque sous forme de dégâts de froid. Ensuite, le sort cesse de faire effet. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, le sort fait effet sur une attaque supplémentaire par niveau au-dessus du premier."
    },
    {
        id: 459,
        nom: 'Mauvais œil',
        ...
        composantes: 'V, S',
        duree: "concentration, jusqu'à 1 minute",
        description: "Pendant la durée du sort, vos yeux deviennent deux trous noirs regorgeant d'un pouvoir terrifiant. Une créature de votre choix, située dans votre champ de vision et dans un rayon de 18 mètres doit réussir un jet de sauvegarde de Sagesse ou se voir affectée par l'un des effets suivants, choisi par vos soins, pendant toute la durée du sort : Nauséeux, Endormi, ou Paniqué. À chacun de vos tours jusqu'à ce que le sort se termine, vous pouvez utiliser votre action pour viser une autre créature, mais vous ne pouvez pas reprendre pour cible une créature ayant déjà réussi un jet de sauvegarde contre l'incantation de mauvais œil en cours."
    },
    {
        id: 460,
        nom: 'Métamorphose suprême',
    ...
    },
    {
        ...
        composantes: 'V',
        duree: 'instantanée',
        description: "Vous prononcez un mot de pouvoir capable de submerger l'esprit d'une créature située à portée et dans votre champ de vision. Elle en est abasourdie. Si elle possède 150 points de vie ou moins, elle est étourdie, sinon le sort est sans effet. Une cible étourdie a droit à un jet de sauvegarde de Constitution à la fin de chacun de ses tours. L'effet d'étourdissement se termine dès qu'elle en réussit un."
    },
    {
        id: 462,
        nom: 'Mot de pouvoir mortel',
        classe: ['Sorcier', 'Barde'],
        niveau: 9,
        ecole: 'Enchantement',
        temps: '1 action',
        ...
        composantes: 'V',
        duree: 'instantanée',
        description: "Vous prononcez un mot de pouvoir capable d'obliger une créature située à portée et dans votre champ de vision à mourir instantanément. Si la créature choisie a 100 points de vie ou moins, elle meurt, sinon le sort n'a aucun effet."
    },
    {
        id: 463,
    ...
    },
    {
        ...
        duree: '8 heures',
        description: "Vous touchez une créature consentante et lui conférez une aptitude limitée à voir dans le futur immédiat. Pendant toute la durée du sort, elle ne peut pas être surprise et elle a l'avantage sur les jets d'attaque, les tests de caractéristique et les jets de sauvegarde. De plus, les autres créatures sont affectées par un désavantage lors de leurs jets d'attaque contre elle pendant toute la durée du sort. Le sort se termine immédiatement si vous le lancez de nouveau avant la fin de sa durée."
    },
    {
        id: 473,
        ...
        description: "Ce sort est un tour de magie basique que les novices utilisent pour s'entraîner. Vous l'utilisez pour créer à portée l'un des effets magiques suivants : un effet sensoriel inoffensif, allumer/éteindre une petite flamme, nettoyer/salir un petit objet, refroidir/réchauffer/aromatiser de la matière non vivante, faire apparaître une marque, ou créer un colifichet non magique/image illusoire dans la main. Si vous lancez le sort à plusieurs reprises, vous ne pouvez pas avoir plus de trois effets non instantanés actifs à la fois."
    },
    {
        id: 474,
        nom: 'Projection astrale',
        ...
        composantes: "V, S, M (un zircon jaune d'une valeur minimale de 1000 po et un lingot d'argent gravé d'une valeur minimale de 100 po par créature - le sort consomme ces composantes)",
        duree: 'spéciale',
        description: "Vous et un maximum de huit créatures consentantes à portée projetez vos corps astraux sur le plan astral (si vous vous trouvez déjà sur ce plan, le sort échoue et l'incantation est gâchée). Les corps physiques que vous laissez derrière vous sont inconscients, en état d'animation suspendue. Ils n'ont pas besoin de nourriture ni d'air et ne vieillissent pas. Votre corps astral ressemble fort à votre corps physique, jusqu'à reproduire son profil technique et dupliquer ses possessions. La principale différence, c'est le cordon argenté qui sort entre vos omoplates et se prolonge derrière vous. Tant que ce lien est intact, vous pourrez rentrer chez vous, mais s'il est coupé, votre âme est séparée de votre corps et vous mourez sur-le-champ. Le sort se termine pour vous et vos compagnons dès que vous utilisez une action pour y mettre fin."
    },
    {
        id: 475,
        nom: 'Protection contre le mal et le bien',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: "concentration, jusqu'à 10 minutes",
        description: "Ce sort vous permet de vous déplacer à une vitesse incroyable. Vous pouvez utiliser l'action se précipiter quand vous le lancez, puis par une action bonus à chacun de vos tours jusqu'à ce que le sort se termine."
    },
    {
        id: 479,
        ...
        niveau: 1,
        ecole: 'Évocation',
        temps: '1 réaction en réponse aux dégâts que vous inflige une créature située dans votre champ de vision et dans un rayon de 18 mètres autour de vous',
        portee: '18 mètres',
        composantes: 'V, S',
        duree: 'instantanée',
        description: "Il vous suffit de pointer le doigt vers la créature qui vient de vous blesser pour qu'elle soit un instant enveloppée d'un linceul de flammes infernales. Elle doit faire un jet de sauvegarde de Dextérité. Si elle échoue, elle subit 2d10 dégâts de feu, sinon la moitié seulement. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, les dégâts augmentent de 1d10 par emplacement de sort au-dessus du 1er."
    },
    {
        id: 480,
        nom: 'Rêve',
        ...
        duree: '8 heures',
        description: "Ce sort façonne les rêves d'une créature. Choisissez comme cible une créature de votre connaissance sur le même plan d'existence. Vous entrez dans un état de transe et servez de messager. Si la cible est endormie, le messager apparaît dans son rêve et peut discuter avec elle pendant toute la durée du sort. Le messager peut aussi modeler l'environnement onirique. Vous pouvez affubler le messager d'une apparence monstrueuse : le message ne dépasse pas dix mots et la cible doit faire un jet de sauvegarde de Sagesse ou subir un cauchemar (pas de repos) et 3d6 dégâts psychiques au réveil."
    },
    {
        id: 481,
        nom: 'Scrutation',
        ...
        composantes: "V, S, M (un focaliseur d'une valeur minimale de 1000 po comme une boule de cristal, un miroir en argent ou un bénitier rempli d'eau bénite)",
        duree: "concentration, jusqu'à 10 minutes",
        description: "Vous voyez et entendez une créature donnée de votre choix, à condition qu'elle se trouve sur le même plan d'existence que vous. La cible doit effectuer un jet de sauvegarde de Sagesse, modifié par le degré de connaissance que vous avez d'elle et le type de lien physique. Si elle rate son jet, le sort crée un organe sensoriel invisible dans un rayon de 3 mètres autour d'elle à travers lequel vous voyez et entendez."
    },
    {
        id: 482,
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: "concentration, jusqu'à 1 minute",
        description: "Vous faites jaillir du sol des stalagmites de pierre d'une hauteur de 3 mètres dans une zone carrée de 3 mètres d'arête à portée du sort. Chaque créature dans la zone doit effectuer une sauvegarde de Dextérité. En cas d'échec, les stalagmites infligent 4d4 dégâts perforants et la cible se retrouve entravée. En cas de succès, elle ne subit que la moitié des dégâts et est libre de ses mouvements. Une cible entravée peut utiliser une action pour tenter un jet de sauvegarde de Force (1d6 dégâts contondants en cas de réussite). Terrain difficile pendant la durée du sort. À plus haut niveau. Dégâts perforants augmentent de 2d4 par niveau au-delà du niveau 2."
    },
    {
        id: 484,
        nom: 'Strangulation',
        ...
        composantes: 'V, S',
        duree: "concentration, jusqu'à 1 minute",
        description: "Vous tendez le bras en direction de votre cible et mimer son étranglement. Faites une attaque de sort à distance. En cas de réussite, la cible subit 1d6 points de dégâts contondants et doit faire un jet de sauvegarde de Force ou être entravée. À chacun de vos tours, vous pouvez utiliser votre action pour lui infliger automatiquement les mêmes dégâts. À plus haut niveau. Dégâts de 2d6 au niveau 3, +1d6 par tranche de 2 niveaux supplémentaires (jusqu'à 5d6 au niveau 9)."
    },
    {
        id: 485,
        nom: 'Suggestion',
        ...
        duree: "concentration, jusqu'à 8 heures",
        description: "Vous visez une créature située à portée qui peut vous entendre et vous comprendre. Vous l'influencez par magie de façon à ce qu'elle suive la conduite que vous lui proposez (1 ou 2 phrases). La conduite doit sembler raisonnable. La cible doit réussir un jet de sauvegarde de Sagesse ou suivre la suggestion pendant toute la durée du sort."
    },
    {
        id: 486,
        nom: 'Suggestion de groupe',
        classe: ['Sorcier', 'Barde'],
        niveau: 6,
        ecole: 'Enchantement',
        temps: '1 action',
        ...
        composantes: "V, M (une langue de serpent et soit un rayon de miel, soit une goutte d'huile d'olive)",
        duree: '24 heures',
        description: "Vous visez un maximum de douze créatures de votre choix situées à portée. Vous les influencez par magie de façon à ce qu'elles suivent la conduite que vous leur proposez (1 ou 2 phrases). Chaque cible doit réussir un jet de sauvegarde de Sagesse ou suivre la suggestion. À plus haut niveau. Emplacement Niv 7 : 10 jours. Niv 8 : 30 jours. Niv 9 : 1 an et 1 jour."
    },
    {
        id: 487,
        nom: 'Ténèbres',
        ...
        duree: "concentration, jusqu'à 10 minutes",
        description: "Des ténèbres magiques se répandent depuis un point de votre choix situé à portée, jusqu'à englober une sphère de 4,50 mètres de rayon. La vision dans le noir ne permet pas de percer ces ténèbres et la lumière non magique ne les éclaire pas. Si le point choisi est un objet porté/transporté, les ténèbres se déplacent avec lui. Recouvrir complètement l'objet bloque les ténèbres. Dissipe les sorts de lumière de niveau 2 ou moins."
    },
    {
        id: 488,
        nom: 'Terrain hallucinatoire',
        classe: ['Sorcier', 'Druide', 'Barde'],
        niveau: 4,
        ecole: 'Illusion',
        temps: '10 minutes',
        ...
        duree: '24 heures',
        description: "Vous maquillez le terrain naturel dans un cube de 45 mètres d'arête situé à portée et lui attribuez l'apparence, les bruits et les odeurs d'un autre type de terrain naturel. Les structures manufacturées, l'équipement et les créatures ne changent pas d'apparence. Un examen attentif permet un test d'Intelligence (Investigation) contre le DD du sort pour percer l'illusion."
    },
    {
        id: 489,
        nom: 'Texte illusoire',
        ...
        duree: '10 jours',
        description: "Vous écrivez sur un matériau adapté et l'imprégnez d'une illusion. À vos yeux et aux créatures désignées, l'écriture semble normale. Pour les autres, les écrits semblent rédigés dans une langue inconnue/inintelligible ou transmettent un message totalement différent."
    },
    {
        id: 490,
        nom: 'Viser juste',
        ...
        description: "Vous tendez la main et pointez du doigt une cible à portée. Votre magie vous donne un bref aperçu de ses défenses. À votre prochain tour, vous avez l'avantage lors de votre premier jet d'attaque contre elle, à condition que le sort ne se soit pas terminé avant."
    },
    {
        id: 491,
        nom: 'Vision suprême',
    ...
    },
    {
        ...
        duree: "concentration, jusqu'à 10 minutes",
        description: 'Vous touchez une créature consentante et lui conférez la capacité de voler à une vitesse de 18 mètres pendant toute la durée du sort.'
    },
    {
        id: 493,
        nom: 'Disque flottant',
    ...
    },
    {
        ...
        duree: 'instantanée',
        description: 'Un éclair formant une ligne de 30 mètres de long pour 1,50 mètre de large jaillit de votre personne et file dans la direction de votre choix. Chaque créature située sur la ligne doit réaliser un jet de sauvegarde de Dextérité. Celles qui échouent subissent 8d6 dégâts de foudre, les autres la moitié seulement. La foudre embrase les objets inflammables de la zone qui ne sont ni portés ni transportés par une créature. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 4 ou supérieur, les dégâts augmentent de 1d6 par niveau au-delà du niveau 3.'
    },
    {
        id: 500,
        nom: 'Éclat du soleil',
        ...
        composantes: 'V, S, M (du feu et un éclat d’héliotrope)',
        duree: 'instantanée',
        description: 'La chaude lumière du soleil illumine une zone de 18 mètres de rayon centrée sur un point de votre choix situé à portée. Chaque créature présente dans cette lumière doit effectuer un jet de sauvegarde de Constitution. Celles qui échouent subissent 12d6 dégâts radiants et sont aveuglées pendant 1 minute. Les autres subissent seulement la moitié des dégâts et ne sont pas aveuglées par le sort. Les vases et les morts-vivants sont affectés par un désavantage lors de ce jet de sauvegarde. Une créature aveuglée par le sort fait un autre jet de Constitution à la fin de chacun de ses tours. Dès qu’elle réussit, sa cécité disparaît. Ce sort dissipe toutes les ténèbres issues d’un sort présentes dans la zone.'
    },
    {
        id: 501,
        nom: 'Embruns prismatiques',
        classe: ['Magicien'],
        niveau: 7,
        ecole: 'Évocation',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: 'instantanée',
        description: 'Huit rayons de lumière multicolores jaillissent de votre main. Chacun a une couleur différente et possède des pouvoirs et objectifs distincts. Chaque créature présente dans un cône de 18 mètres doit faire un jet de sauvegarde de Dextérité. Lancez 1d8 par cible pour savoir quelle couleur l’affecte. 1. Rouge. La cible subit 10d6 dégâts de feu si elle rate son jet de sauvegarde, la moitié seulement si elle le réussit. 2. Orange. La cible subit 10d6 dégâts d’acide si elle rate son jet de sauvegarde, la moitié seulement si elle le réussit. 3. Jaune. La cible subit 10d6 dégâts de foudre si elle rate son jet de sauvegarde, la moitié seulement si elle le réussit. 4. Vert. La cible subit 10d6 dégâts de poison si elle rate son jet de sauvegarde, la moitié seulement si elle le réussit. 5. Bleu. La cible subit 10d6 dégâts de froid si elle rate son jet de sauvegarde, la moitié seulement si elle le réussit. 6. Indigo. Si la cible rate son jet de sauvegarde, elle est entravée et doit alors faire un jet de sauvegarde de Constitution à la fin de chacun de ses tours. Si elle en réussit trois, le sort se termine, si elle en rate trois, elle se change définitivement en pierre et est pétrifiée. Les succès et les échecs n’ont pas à être consécutifs : tenez le compte dans chaque catégorie jusqu’à ce que l’une d’elles arrive à trois. 7. Violet. La cible est aveuglée si elle rate son jet de sauvegarde. Elle doit alors faire un jet de sauvegarde de Sagesse au début de votre prochain tour. Si elle le réussit, elle recouvre la vue ; si elle le rate, elle est emportée sur un autre plan d’existence choisi par le MJ et recouvre aussi la vue. (En général, une créature qui ne se trouve pas sur son propre plan d’existence est bannie là-bas tandis que les autres créatures sont envoyées sur le plan astral ou éthéré.) 8. Spécial. Deux rayons viennent frapper la cible. Relancez deux fois le dé en le relançant à chaque fois que vous obtenez un 8.'
    },
    {
        id: 502,
        nom: 'Emprisonnement',
        ...
        composantes: 'V, S, M (un portrait sur un vélin ou une statuette sculptée à l’effigie de la cible et une composante spéciale qui varie en fonction de la version du sort choisie et vaut au moins 500 po par dé de vie de la cible)',
        duree: 'jusqu’à dissipation',
        description: 'Vous créez des entraves magiques pour immobiliser une créature située à portée et dans votre champ de vision. La cible doit réussir un jet de sauvegarde de Sagesse ou se retrouver emprisonnée par le sort. Si elle réussit, elle est immunisée contre ce sort si vous le lancez de nouveau. Tant que la créature est affectée par le sort, elle n’a pas besoin de respirer, de manger, ni de boire et ne vieillit plus. Les sorts de divination ne parviennent plus à la localiser ni à la percevoir. Vous devez opter pour l’une des formes d’emprisonnement suivantes quand vous lancez le sort. Confinement minimal. La cible rétrécit jusqu’à ne plus faire que 2,5 centimètres de haut et se retrouve emprisonnée dans une gemme ou un objet similaire. La lumière traverse la gemme normalement (ce qui permet à la cible de voir l’extérieur et aux autres créatures de regarder dedans) mais rien d’autre ne peut traverser sa paroi, pas même les méthodes de téléportation ni les voyages planaires. Il est impossible de tailler la gemme ou de la briser tant que le sort fait effet. La composante spéciale de cette version du sort est une grande gemme transparente comme un corindon, un diamant ou un rubis. Enchaîné. La cible est retenue par de lourdes chaînes fermement ancrées au sol. Elle est entravée jusqu’à ce que le sort se termine et, jusque-là, elle ne peut pas se déplacer ni être déplacée par quelque moyen que ce soit. La composante spéciale de cette version du sort est une fine chaîne faite de métal précieux. Enseveli. La cible est ensevelie dans les profondeurs de la terre, dans une sphère de force magique tout juste assez grande pour la contenir. Rien ne peut traverser cette sphère et les créatures ne peuvent pas recourir au voyage planaire pour y entrer ou en sortir. La composante spéciale de cette version du sort est un petit orbe en mithral. Prison isolée. Le sort transporte la cible dans un minuscule demi-plan protégé contre la téléportation et les voyages planaires. Ce demi-plan peut-être un labyrinthe, une cage, une tour ou une structure confinée similaire de votre choix. La composante spéciale de cette version du sort est une représentation miniature de la prison, faite de jade. Sommeil. La cible s’endort et il est impossible de la réveiller. La composante spéciale de cette version du sort est un bouquet d’herbes soporifiques très rares. Mettre fin au sort. Lors de l’incantation et quelle que soit la version du sort, vous pouvez préciser une condition spéciale qui met fin au sort et libère la cible. Cette condition peut être aussi spécifique ou aussi élaborée que vous le désirez, mais le MJ doit confirmer que cette condition est réalisable et a une chance d’être remplie. Elle peut se baser sur le nom de la créature, son identité ou sa divinité, mais elle doit sinon reposer sur des actions ou des qualités observables et non sur des éléments intangibles comme le niveau, la classe ou les points de vie. Dissipation de la magie peut mettre fin au sort à condition d’être lancée depuis un emplacement de sort de niveau 9 en visant la prison ou la composante matérielle spéciale utilisée pour lancer le sort. Vous pouvez utiliser une composante spéciale pour créer une prison à la fois seulement. Si vous relancez ce sort en utilisant la même composante, la cible de la première incantation est libérée sur-le-champ.'
    },
    {
        id: 503,
        nom: 'Entrave planaire',
        ...
        composantes: 'V, S, M (un bijou d’une valeur minimale de 1000 po, que le sort consume)',
        duree: '24 heures',
        description: 'Grâce à ce sort, vous vous attachez de force les services d’un céleste, d’un élémentaire, d’une fée ou d’un fiélon. La créature doit se trouver à portée pendant toute la durée du sort. (En général, elle est d’abord invoquée au centre d’un cercle magique inversé où elle reste piégée le temps de l’incantation.) La cible doit faire un jet de sauvegarde de Charisme à la fin de l’incantation. Si elle échoue, elle est contrainte de vous servir pendant toute la durée du sort. Si elle a été invoquée ou créée via un autre sort, la durée de ce dernier se prolonge jusqu’à égaler celle de l’entrave planaire. La créature liée doit suivre vos instructions au mieux de ses capacités. Vous pouvez lui demander de vous accompagner lors d’une aventure, de protéger un lieu ou de transmettre un message. La créature suit vos instructions à la lettre mais, si elle est hostile envers vous, elle peut tout à fait interpréter vos paroles de manière à satisfaire ses propres objectifs. Si la créature a exécuté vos instructions avant la fin du sort, elle revient vers vous pour vous en informer si elle se trouve sur le même plan d’existence que vous. Si vous êtes sur un autre plan, elle se rend là où vous l’avez liée et y reste jusqu’à la fin du sort. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau supérieur, la durée augmente : 10 jours au niveau 6, 30 au niveau 7, 180 au niveau 8 et 1 an et 1 jour au niveau 9.'
    },
    {
        id: 504,
        nom: 'Envoi de message',
    ...
    },
    {
        ...
        composantes: 'V, S, M (une poignée de sphères en argile, en cristal, en verre ou minérales)',
        duree: 'instantanée',
        description: 'Vous vous attaquez à l’esprit d’une créature située à portée et dans votre champ de vision en essayant de briser son intellect et sa personnalité. La cible subit 4d6 dégâts psychiques et doit effectuer un jet de sauvegarde d’Intelligence. Si la cible rate son jet, son Intelligence et son Charisme tombent à 1. Elle ne peut plus lancer de sort, activer d’objet magique, comprendre une langue ni communiquer de manière intelligible. En revanche, elle est toujours capable de reconnaître ses amis, de les suivre et même de les protéger. La créature peut refaire un jet de sauvegarde tous les 30 jours. Le sort se termine dès qu’elle réussit. On peut aussi mettre un terme à ce sort grâce à l’un des sorts suivants : restauration supérieure, guérision ou souhait.'
    },
    {
        id: 507,
        nom: 'Esprit impénétrable',
    ...
    },
    {
        ...
        composantes: 'V, S, M (de minuscules tartes et une plume à agiter dans les airs)',
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Une créature de votre choix située à portée et dans votre champ de vision trouve soudain tout ce qui l’entoure d’une drôlerie hilarante et succombe à un fou rire irrépressible dès que ce sort l’affecte. Elle doit réussir un jet de sauvegarde de Sagesse ou se retrouver à terre, neutralisée et incapable de se relever pendant toute la durée du sort. Ce sort n’affecte pas les créatures dotées d’une Intelligence de 4 ou moins. À la fin de chacun de ses tours et à chaque fois qu’elle subit des dégâts, la cible a droit à un nouveau jet de sauvegarde de Sagesse. Elle bénéficie d’un avantage lors de ce jet si ce sont des dégâts qui l’ont provoqué. Si le jet est réussi, le sort se termine.'
    },
    {
        id: 519,
        nom: 'Globe d’invulnérabilité',
        classe: ['Magicien'],
        niveau: 6,
        ecole: 'Abjuration',
        temps: '1 action',
        portee: 'personnelle (3 mètres)',
        composantes: 'V, S, M (une perle de verre ou de cristal qui explose à la fin du sort)',
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Une barrière immobile scintille légèrement dans un rayon de 3 mètres autour de vous et persiste pendant toute la durée du sort. Tout sort de niveau 5 ou inférieur lancé depuis l’extérieur de la barrière se trouve dans l’incapacité d’affecter les créatures et les objets se trouvant à l’intérieur, même si le lanceur de sort utilise un emplacement de niveau supérieur. Le sort peut très bien viser les créatures et les objets situés au sein de la barrière, mais il n’a aucun effet sur eux. De même, la zone protégée par la barrière est exclue de la zone affectée par les sorts de ces niveaux. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 7 ou supérieur, la barrière bloque les sorts d’un niveau de plus par niveau au-delà du niveau 6.'
    },
    {
        id: 520,
        nom: 'Glyphe de protection',
    ...
    },
    {
        ...
        composantes: 'V, S, M (une pincée de poussière)',
        duree: '1 heure',
        description: 'Vous touchez une créature dont la vitesse augmente de 3 mètres jusqu’à la fin du sort. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, vous pouvez affecter une créature de plus par niveau au-delà du niveau 1.'
    },
    {
        id: 523,
        nom: 'Hâte',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'concentration, jusqu’à 10 minutes',
        description: 'Vous bannissez une créature située à portée et dans votre champ de vision dans un demi-plan labyrinthique. La cible y reste pendant toute la durée du sort, ou jusqu’à ce qu’elle s’échappe du dédale. Elle peut utiliser une action pour tenter de s’évader. Pour cela, elle effectue un test d’Intelligence DD 20. Si elle le réussit, elle s’échappe et le sort se termine (les minotaures et les démons goristros réussissent automatiquement). Quand le sort se termine, la cible réapparaît à l’emplacement qu’elle a quitté ou, s’il est occupé, dans l’emplacement libre le plus proche.'
    },
    {
        id: 540,
        nom: 'Langues',
    ...
    },
    {
        ...
        niveau: 1,
        ecole: 'Transmutation',
        temps: '1 réaction, que vous effectuez quand vous-même ou une créature située dans un rayon de 18 mètres tombe soudain',
        portee: '18 mètres',
        composantes: 'V, M (une petite plume ou un peu de duvet)',
        duree: '1 minute',
        description: 'Choisissez jusqu’à cinq créatures à portée en train de chuter. La vitesse de chute de chacune passe à 18 mètres par round jusqu’à la fin du sort. Si une créature atterrit avant la fin du sort, elle ne subit pas de dégât de chute et se reçoit sur ses pieds, le sort se terminant alors pour elle.'
    },
    {
        id: 543,
        nom: 'Lenteur',
    ...
    },
    {
        ...
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Vous créez une main de force luisante et translucide, de taille G, dans un espace inoccupé situé à portée et dans votre champ de vision. La main existe pendant toute la durée du sort, se déplace sur votre ordre et imite les mouvements de votre propre main. La main est un objet doté d’une CA de 20 et d’un nombre de points de vie égal à votre maximum de points de vie. Si elle tombe à 0 point de vie, le sort se dissipe. La main possède une Force de 26 (+8) et une Dextérité de 10 (+0). Elle n’occupe pas la case où elle se trouve. Lorsque vous lancez le sort, puis via une action bonus lors de vos tours ultérieurs, vous pouvez déplacer la main sur une distance maximale de 18 mètres et lui faire appliquer l’un des effets suivants. Main agrippeuse. La main tente d’empoigner une créature de taille TG ou inférieure qui se trouve dans un rayon de 1,50 mètre. Utilisez la valeur de Force de la main pour résoudre le test d’empoignade. Si la cible est de taille M ou inférieure, vous bénéficiez d’un avantage lors du test. Tant que la cible est empoignée par la main, vous pouvez utiliser une action bonus pour que la main la broie. Dans ce cas, la cible subit un total de dégâts contondants égal à 2d6 + votre modificateur de caractéristique d’incantation. Main interposée. La main s’interpose entre vous et une créature de votre choix jusqu’à ce que vous lui donniez un autre ordre. Elle se déplace de manière à toujours rester entre vous et la cible désignée et vous offre un abri partiel contre elle. La cible ne peut pas franchir la zone occupée par la main si sa valeur de Force est inférieure ou égale à celle de la main. Si elle est supérieure, elle peut se déplacer dans votre direction en traversant la zone de la main, mais cette zone est considérée pour elle comme un terrain difficile. Main percutante. La main tente de bousculer une créature située dans un rayon de 1,50 mètre dans la direction de votre choix. Faites un test avec la Force de la main opposé au test de Force (Athlétisme) de la cible. Si cette dernière est de taille M ou inférieur, vous bénéficiez d’un avantage lors du test. Si vous l’emportez, la main pousse la cible sur 1,50 mètre plus 1,50 mètre multiplié par votre modificateur de caractéristique d’incantation. La main se déplace de manière à rester à moins de 1,50 mètre de la cible. Poing serré. La main frappe une créature ou un objet situé dans un rayon de 1,50 mètre autour d’elle. Faites une attaque de sort de contact pour la main en utilisant vos propres bonus d’attaque. Si elle touche, la cible subit 4d8 dégâts de force. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 6 ou supérieur, les dégâts de l’option poing serré augmentent de 2d8 et ceux de la main agrippeuse de 2d6 par niveau au-delà du niveau 5.'
    },
    {
        id: 553,
        nom: 'Mains brûlantes',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Pendant la durée du sort, vos yeux deviennent deux trous noirs regorgeant d’un pouvoir terrifiant. Une créature de votre choix, située dans votre champ de vision et dans un rayon de 18 mètres doit réussir un jet de sauvegarde de Sagesse ou se voir affectée par l’un des effets suivants, choisi par vos soins, pendant toute la durée du sort. À chacun de vos tours jusqu’à ce que le sort se termine, vous pouvez utiliser votre action pour viser une autre créature, mais vous ne pouvez pas reprendre pour cible une créature ayant déjà réussi un jet de sauvegarde contre l’incantation de mauvais œil en cours. Nauséeux. La cible est affectée par un désavantage lors des jets d’attaque et des tests de caractéristique. Elle a droit à un nouveau jet de sauvegarde de Sagesse à la fin de chacun de ses tours. L’effet se termine si elle le réussit. Endormi. La cible tombe inconsciente. Elle se réveille si elle subit le moindre dégât ou si une tierce personne utilise une action pour la réveiller en la secouant. Paniqué. Vous terrorisez la cible. À chacun de ses tours, la cible terrorisée doit utiliser l’action se précipiter et s’éloigner de vous via l’itinéraire le plus rapide et le plus sûr, à moins qu’elle n’ait nulle part où aller. Cet effet se termine si la cible gagne un emplacement situé à au moins 18 mètres de vous et d’où elle ne vous voit plus.'
    },
    {
        id: 556,
        nom: 'Message',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'instantanée',
        description: 'Des orbes de feu flamboyants s’abattent au sol en quatre points de votre choix situés à portée et dans votre champ de vision. Chaque créature située dans la sphère de 12 mètres de rayon centrée sur chacun de ces points doit effectuer un jet de sauvegarde de Dextérité. Les sphères s’étendent en contournant les angles. Une créature qui rate son jet de sauvegarde subit 20d6 dégâts de feu et 20d6 dégâts contondants, les autres la moitié seulement. Une créature qui se trouve prise dans deux sphères à la fois ne subit qu’une seule fois les dégâts des météores. Le sort abîme et embrase les objets inflammables de la zone s’ils ne sont pas portés ou transportés.'
    },
    {
        id: 577,
        nom: 'Œil magique',
    ...
    },
    {
        ...
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Vous désignez une cible à portée et dans votre champ de vision. Vous créez des images fantasmagoriques cauchemardesques dans son esprit. La victime doit réussir un jet de sauvegarde d’Intelligence. En cas d’échec, elle perçoit des silhouettes d’ombres qui l’assaillent, ce qui lui inflige un désavantage à toutes ses actions pendant la durée du sort. À plus haut niveau. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 5 ou supérieur, le sort persiste jusqu’à la fin de sa durée normale sans nécessiter de concentration.'
    },
    {
        id: 580,
        nom: 'Pas brumeux',
    ...
    },
    {
        ...
        duree: '24 heures',
        description: 'Vous créez un sceau protégeant une zone au sol de 225 mètres carrés (soit une zone de 15 mètres de côté, soit une centaine de zones de 1,50 mètre de côté, soit vingt-cinq zones de 3 mètres de côté). La zone protégée fait au maximum 6 mètres de haut et prend la forme de votre choix. Vous pouvez protéger ainsi plusieurs étages d’une place forte en répartissant la zone affectée entre eux tant que vous pouvez relier toutes les zones contiguës en marchant lorsque vous lancez le sort. Lors de l’incantation, vous pouvez définir quels individus ne seront pas affectés par un ou tous les effets du sort. Vous pouvez aussi choisir un mot de passe qui immunise celui qui le prononce à haute voix contre ces effets. Protections et sceaux produit les effets suivants dans la zone protégée. Couloirs. Le brouillard envahit tous les couloirs, où la visibilité est alors nulle. De plus, à chaque intersection ou embranchement laissant un choix de direction, il y a 50 % de chances que les créatures autres que vous soient persuadées d’aller dans la direction opposée à celle qu’elles ont choisie. Escaliers. Des toiles d’araignées, comme le sort du même nom, emplissent tous les escaliers de la zone protégée, du sol au plafond. Tant que protections et sceaux persiste, ces fils réapparaissent en 10 minutes si quelqu’un les brûle ou les arrache. Portes. Toutes les portes de la zone protégée sont fermées par magie, comme scellées avec un verrou magique. De plus, vous pouvez recouvrir jusqu’à dix portes d’une illusion (comme la fonction d’objet illusoire du sort illusion mineure), afin de les faire passer pour une section de mur ordinaire. Autres effets de sort. Vous pouvez placer l’un des effets suivants, au choix, dans la zone protégée par le sort. • Placer lumières dansantes dans quatre couloirs. Vous pouvez choisir un programme très simple que les lumières suivront pendant toute la durée de protections et sceaux. • Placer une bouche magique en deux endroits. • Placer un nuage puant en deux endroits. Les vapeurs apparaissent à l’endroit de votre choix. Tant que protections et sceaux persiste, elles réapparaissent au bout de 10 minutes si le vent les disperse. • Placer une bourrasque constante dans un couloir ou une pièce. • Placer une suggestion en un endroit. Choisissez une zone d’au maximum 1,50 mètre de côté : toute créature qui y pénètre ou la traverse reçoit une suggestion mentale. Toute la zone protégée émet une aura magique. Si quelqu’un lance avec succès une dissipation de la magie sur un effet spécifique, il élimine seulement cet effet. Vous pouvez protéger une structure en permanence si vous lancez ce sort tous les jours pendant un an.'
    },
    {
        id: 600,
        nom: 'Rayon affaiblissant',
    ...
    },
    {
        ...
        composantes: 'V, S',
        duree: 'instantanée',
        description: 'Vous créez trois rayons de feu et les projetez sur des cibles à portée. Vous pouvez les diriger contre une même cible ou contre des cibles différentes. Faites une attaque de sort à distance pour chaque rayon. Si vous touchez, la cible reçoit 2d6 dégâts. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 3 ou supérieur, vous créez un rayon de plus par niveau au-delà du niveau 2.'
    },
    {
        id: 602,
        nom: 'Rayon de givre',
    ...
    },
    {
        ...
        duree: '24 heures',
        description: 'Vous sécurisez par magie une zone à portée. Il s’agit d’un cube de 1,50 mètre à 30 mètres d’arête. Le sort persiste pendant toute sa durée ou jusqu’à ce que vous utilisiez une action pour le révoquer. Vous décidez de la sécurité offerte par le sort au moment de l’incantation en choisissant une ou plusieurs propriétés parmi les suivantes. • Les sons ne peuvent pas franchir la barrière qui délimite la zone protégée. • La barrière délimitant la zone protégée est sombre et brumeuse, ce qui empêche de voir au travers (même avec la vision dans le noir). • Les organes sensoriels créés via un sort de divination ne peuvent pas apparaître au sein de la zone protégée ni traverser la barrière qui délimite son périmètre. • Les sorts de divination ne peuvent pas prendre les créatures de la zone pour cible. • Rien ne peut se téléporter à l’intérieur ou à l’extérieur de la zone protégée. • Les voyages planaires sont bloqués au sein de la zone protégée. Si on lance ce sort tous les jours au même endroit pendant un an, ses effets deviennent permanents. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 5 ou supérieur, vous pouvez augmenter la taille du cube de 30 mètres par niveau au-delà du niveau 4. Ainsi, avec un emplacement de niveau 5, vous pouvez protéger une zone de 60 mètres de côté.'
    },
    {
        id: 610,
        nom: 'Sang du démon',
    ...
    },
    {
        ...
        duree: '1 heure',
        description: 'Vous renforcez votre corps avec un ersatz de vie et gagnez 1d4+4 points de vie temporaires pendant la durée du sort. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, vous gagnez 5 points de vie temporaires supplémentaires par niveau au-delà du niveau 1.'
    },
    {
        id: 617,
        nom: 'Sommeil',
    ...
    },
    {
        ...
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Une sphère de force scintillante englobe une créature ou un objet de taille G ou inférieure situés à portée. Si la cible n’est pas consentante, elle a droit à un jet de sauvegarde de Dextérité. Si elle le rate, elle est enfermée dans la sphère pour toute la durée du sort. Rien ne peut franchir la barrière que forme la sphère : ni les objets physiques, ni l’énergie, ni les effets des autres sorts. En revanche, une créature qui se trouve au sein de la sphère y respire sans mal. La sphère est immunisée contre tous les types de dégâts. De plus, les attaques et les effets originaires de l’extérieur de la sphère ne peuvent pas blesser la créature ou l’objet qu’elle abrite. De même, une créature au sein de la sphère est incapable d’endommager ce qui se trouve à l’extérieur. La sphère ne pèse rien et elle est tout juste assez grande pour contenir la créature ou l’objet qu’elle renferme. Une créature enfermée dans la sphère peut utiliser son action pour exercer une poussée sur la paroi de la sphère et la faire rouler à la moitié de sa vitesse habituelle. De même, une tierce personne peut ramasser la sphère ou la déplacer. Un sort de désintégration visant la sphère la détruit sans endommager ce qu’elle contient.'
    },
    {
        id: 622,
        nom: 'Stalagmites fulgurantes',
    ...
    },
    {
        ...
        composantes: 'V',
        duree: 'instantanée',
        description: 'Ce sort vous transporte instantanément à la destination de votre choix, ainsi qu’un maximum de huit créatures consentantes de votre choix situées à portée et dans votre champ de vision ou bien ainsi qu’un unique objet situé à portée et dans votre champ de vision. Si vous prenez un objet pour cible, il doit tenir dans un cube de 3 mètres de côté et il ne doit pas être porté ni transporté par une créature non consentante. Vous devez choisir une destination connue, située sur le même plan d’existence que vous. C’est votre degré de familiarité avec la destination qui détermine vos chances d’arriver sur place. Le MJ lance 1d100 et consulte la table ci-dessous. Familiarité. « Cercle permanent » désigne un cercle de téléportation dont vous connaissez la séquence de symboles. « Objet associé » indique que vous possédez un objet prélevé à la destination choisie au cours des 6 derniers mois, comme un livre sorti de l’étagère de la bibliothèque d’un magicien, les draps d’une suite royale ou un éclat de marbre arraché au tombeau secret d’une liche. « Très familier » désigne un endroit où vous vous êtes souvent rendu, un lieu que vous avez soigneusement étudié ou un endroit que vous voyez au moment de l’incantation. « Vu à quelques reprises » correspond aux endroits que vous avez vus plus d’une fois, mais avec lesquels vous n’êtes pourtant pas très familiers. « Vu une fois » représente un lieu vu une seule fois, éventuellement par magie. « Description » correspond à un endroit que vous connaissez seulement via la description d’autrui, aussi bien au niveau de son emplacement que de son apparence, éventuellement grâce à une carte. « Destination factice » désigne les endroits qui n’existent pas, si par exemple vous avez tenté de scruter le sanctuaire d’un ennemi mais n’avez vu qu’une illusion ou si vous essayez de vous téléporter en un endroit familier qui n’existe plus. Sur place. Vous et vos compagnons (ou l’objet téléporté) apparaissez exactement où vous le souhaitiez. À proximité. Vous et vos compagnons (ou l’objet téléporté) apparaissez à une distance aléatoire de votre destination, éloignés dans une direction tout aussi aléatoire. La distance qui vous sépare de votre destination est de 1d10 x 1d10 % de la distance que le sort vous a fait parcourir. Par exemple, si vous essayez de vous téléporter à une destination située à 180 kilomètres de votre position, que vous arrivez à proximité, et que vous obtenez 5 et 3, vous allez arriver à 15 % de distance de votre destination, c’est-à-dire à 27 kilomètres. Le MJ détermine la direction dans laquelle vous vous êtes éloignés de la cible en lançant 1d8, le 1 représentant le Nord, le 2 le Nord-Est, le 3 l’Est, etc., jusqu’à faire le tour de la rose des vents. Si vous comptiez vous téléporter dans une cité portuaire et arrivez à 27 kilomètres au large de ses côtes, en pleine mer, vous pourriez bien avoir quelques ennuis. Zone similaire. Vous et vos compagnons (ou l’objet téléporté) arrivez dans une zone différente de celle prévue, mais dotée de caractéristiques visuelles ou thématiques similaires. Par exemple, si vous comptiez regagner votre laboratoire, vous pourriez arriver dans celui d’un autre magicien ou dans une boutique d’alchimie qui possède nombre d’outils et d’appareils présents dans votre laboratoire. En général, vous apparaissez dans l’endroit ressemblant à votre destination le plus proche de celle-ci, mais comme le sort n’a pas de limite de portée, vous pouvez tout à fait arriver n’importe où sur votre plan d’existence. Incident. La magie imprévisible du sort complique le voyage. Chaque créature téléportée (ou l’objet téléporté) subit 3d10 dégâts de force tandis que le MJ relance le dé pour savoir où vous arrivez (sachant qu’il peut se produire plusieurs incidents, chacun infligeant ses propres dégâts). Cercle permanent ou Objet associé : 01-100 : Sur place Très familier : 01-05 : Incident 06-13 : Zone similaire 14-24 : À proximité 25-100 : Sur place Vu à quelques reprises : 01-33 : Incident 34-43 : Zone similaire 44-53 : À proximité 54-100 : Sur place Vu une seule fois : 01-43 : Incident 44-53 : Zone similaire 54-73 : À proximité 74-100 : Sur place Description : 01-43 : Incident 44-53 : Zone similaire 54-73 : À proximité 74-100 : Sur place Destination factice : 01-50 : Incident 51-100 : Zone similaire'
    },
    {
        id: 629,
        nom: 'Tempête de grêle',
        classe: ['Magicien', 'Druide'],
        niveau: 4,
        ecole: 'Évocation',
        temps: '1 action',
    ...
    },
    {
        ...
        composantes: 'V, M (des poils de chauve-souris et une goutte de poix ou un bout de charbon)',
        duree: 'concentration, jusqu’à 10 minutes',
        description: 'Des ténèbres magiques se répandent depuis un point de votre choix situé à portée, jusqu’à englober une sphère de 4,50 mètres de rayon. Les ténèbres s’étendent en franchissant tout angle éventuel. La vision dans le noir d’une créature ne suffit pas à percer ces ténèbres et les lumières non-magiques se révèlent incapables de les éclairer. Si le point que vous avez choisi est un objet en votre possession ou un objet qui n’est ni porté ni transporté par autrui, les ténèbres émanent de l’objet et se déplacent avec lui. Il suffit de recouvrir complètement l’objet affecté avec un objet opaque, comme un bol ou un heaume, pour bloquer les ténèbres. Si une partie de la zone affectée par ce sort chevauche une zone de lumière issue d’un sort de niveau 2 ou moins, elle dissipe le sort de lumière.'
    },
    {
        id: 632,
        nom: 'Tentacules noirs',
        classe: ['Magicien'],
        niveau: 4,
        ecole: 'Invocation',
        temps: '1 action',
        ...
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Des tentacules noirs grouillants envahissent le sol d’un emplacement de 6 mètres de côté situé à portée et dans votre champ de vision. Pendant toute la durée du sort, ils transforment la zone en terrain difficile. Quand une créature pénètre dans la zone affectée pour la première fois au cours d’un tour, ou quand elle débute son tour dans cette zone, elle doit réussir un jet de sauvegarde de Dextérité, sans quoi elle reçoit 3d6 dégâts contondants et se retrouve entravée par les tentacules jusqu’à la fin du sort. Une créature qui commence son tour déjà entravée dans la zone subit 3d6 dégâts contondants. Une créature entravée par les tentacules peut utiliser son action pour effectuer un test de Force ou de Dextérité (à elle de choisir) contre le DD de sauvegarde de votre sort. Si elle le réussit, elle parvient à se libérer.'
    },
    {
        id: 633,
        nom: 'Terrain hallucinatoire',
    ...
    },
    {
        ...
        composantes: 'S, M (de l’encre à base de plomb valant au minimum 10 po, que le sort consume)',
        duree: '10 jours',
        description: 'Vous écrivez sur un papier, un parchemin ou un autre matériau adapté à l’écriture et l’imprégnez d’une puissante illusion qui persiste pendant toute la durée du sort. À vos yeux et à ceux de toutes les créatures que vous désignez lors de l’incantation, l’écriture semble normale, de votre main, et transmet le message que vous aviez en tête en rédigeant le texte. Pour les autres personnes, vos écrits semblent appartenir à une langue inconnue ou magique complètement inintelligible, ou alors ils transmettent un message complètement différent de la réalité, rédigé d’une main qui n’est pas la vôtre et dans une autre langue de votre connaissance. Si quelqu’un dissipe le sort, l’illusion disparaît, mais le message original aussi. Une créature dotée de vision parfaite est capable de lire le message original.'
    },
    {
        id: 635,
    ...
    },
    {
        ...
        composantes: 'V, S, M (une petite boule de guano de chauve-souris et du soufre)',
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Un rayon de lumière jaune jaillit de votre doigt tendu et se condense pour former une bille luisante en un point de votre choix situé à portée pendant toute la durée du sort. Quand le sort se termine, soit parce que votre concentration se brise, soit parce que vous y mettez volontairement un terme, la bille se dilate dans un grondement sourd et explose en une gerbe de feu qui s’étend en franchissant les angles éventuels. Toutes les créatures situées dans une sphère de 6 mètres de rayon centrée sur le point où se trouvait la bille doivent faire un jet de sauvegarde de Dextérité. Celles qui échouent subissent un montant de dégâts de feu égal au total de dégâts accumulés (voir plus loin), les autres la moitié seulement. À la base, le sort inflige 12d6 dégâts de feu. À la fin de votre tour, si la bille n’a pas encore explosé, ces dégâts augmentent de 1d6. Si quelqu’un touche la bille avant la fin de l’intervalle, il doit effectuer un jet de sauvegarde de Dextérité. S’il échoue, le sort se termine immédiatement et la bille explose. S’il réussit, il peut lancer la bille à une distance maximale de 12 mètres. Si elle touche un objet solide ou une créature, le sort se termine et la bille explose. Les flammes endommagent les objets qui se trouvent dans la zone et embrasent les objets inflammables qui ne sont ni portés ni transportés. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 8 ou supérieur, les dégâts de base augmentent de 1d6 par niveau au-delà du niveau 7.'
    },
    {
        id: 646,
        nom: 'Bourrasque',
    ...
    },
    {
        ...
        composantes: 'V',
        duree: '1 minute',
        description: 'Vous pouvez rendre un ennemi sourd ou aveugle. Choisissez une créature autre que vous qui se situe à portée et dans votre champ de vision. Elle doit effectuer un jet de sauvegarde de Constitution. Si elle échoue, elle est soit aveuglée, soit assourdie (à vous de choisir) pendant toute la durée du sort. Elle a droit à un nouveau jet de sauvegarde de Constitution à la fin de chacun de ses tours, le sort se terminant si elle le réussit. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 3 ou supérieur, vous pouvez viser une créature de plus par niveau au-delà du niveau 2.'
    },
    {
        id: 649,
        nom: 'Cercle de mort',
    ...
    },
    {
        ...
        composantes: 'V, S, M (un éclat d’ambre, de verre ou de cristal, trois épingles en argent et un morceau de fourrure)',
        duree: 'instantanée',
        description: 'Vous créez un arc électrique qui file vers une cible de votre choix, située à portée et dans votre champ de vision. Trois éclairs bondissent ensuite de cette cible sur un maximum de trois autres cibles qui doivent toutes se trouver dans un rayon de 9 mètres autour de la première. Une cible peut être une créature ou un objet et ne peut recevoir qu’un seul éclair. Chaque cible doit faire un jet de sauvegarde de Dextérité et subit 10d8 dégâts de foudre en cas d’échec, la moitié en cas de réussite. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 7 ou supérieur, un éclair de plus rebondit de la première cible vers une autre pour chaque niveau au-delà du niveau 6.'
    },
    {
        id: 652,
        nom: 'Changement de plan',
    ...
    },
    {
        ...
        composantes: 'V, S, M (trois coquilles de noix)',
        duree: 'concentration, jusqu’à 1 minute',
        description: 'Ce sort assaille et pervertit l’esprit des créatures, génère des hallucinations et provoque des réactions incontrôlées. Toutes les créatures situées dans une sphère de 3 mètres de rayon autour d’un point de votre choix situé à portée doivent réussir un jet de sauvegarde de Sagesse ou être affectées par ce sort. Une cible affectée ne peut pas utiliser de réaction et doit lancer 1d10 au début de chacun de ses tours pour déterminer comment elle se comporte pendant le tour. 1 : La créature utilise la totalité de son mouvement pour se déplacer dans une direction aléatoire. Pour déterminer cette dernière, lancez un d8 en assignant une direction à chaque face. La créature n’effectue aucune action pour ce tour. 2-6 : La créature ne bouge pas et n’entreprend pas la moindre action pour ce tour. 7-8 : La créature utilise son action pour porter une attaque au corps-à-corps contre une créature aléatoire à portée d’allonge. S’il n’y a pas de créature à portée, elle ne fait rien durant le tour. 9-10 : La créature peut agir et se déplacer normalement. Une créature affectée peut faire un jet de sauvegarde de Sagesse à la fin de chacun de ses tours. En cas de succès, l’effet se termine pour elle. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 5 ou supérieur, le rayon de la sphère augmente de 1,50 mètre par niveau au-delà du niveau 4.'
    },
    {
        id: 659,
        nom: 'Contact glacial',
    ...
    },
    {
        ...
        composantes: 'V, S, M (une poignée de poudre ou de sable, colorée en rouge, jaune et bleu)',
        duree: '1 round',
        description: 'Un éventail de lumières colorées éblouissantes jaillit de votre main. Lancez 6d10. Le total représente le nombre de points de vie de créatures que le sort affecte. Les créatures situées dans un cône de 4,50 mètres, prenant votre personne comme point d’origine, sont affectées dans l’ordre croissant de leurs points de vie actuels (en ignorant les créatures inconscientes et les créatures aveuglées. Chaque créature affectée, en commençant par celle qui possède actuellement le moins de points de vie, est aveuglée jusqu’à la fin du sort. Soustrayez du total obtenu le nombre de points de vie actuel de chaque créature affectée avant de passer à la suivante, en choisissant chaque fois celle qui possède le moins de points de vie. Pour qu’une créature soit affectée, elle doit posséder un nombre de points de vie actuels inférieur ou égal au total restant. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 2 ou supérieur, lancez 2d10 supplémentaires par niveau au-delà du niveau 1.'
    },
    {
        id: 662,
        nom: 'Création',
        ...
        composantes: 'V, S, M (un petit bout de matière de même type que l’objet que vous voulez créer)',
        duree: 'spéciale',
        description: 'Vous tirez des bribes de matière ombreuse du plan de l’ombre pour créer à portée des objets inertes en matière végétale : du tissu, de la corde, du bois ou des objets similaires. Ce sort permet aussi de créer des objets minéraux comme de la pierre, du cristal ou du métal. L’objet créé ne doit pas être plus grand qu’un cube de 1,50 mètre d’arête et doit impérativement être d’une forme et d’un matériau que vous avez déjà vus. La durée du sort dépend du matériau choisi pour façonner l’objet. S’il est fait de plusieurs matières, c’est la durée la plus courte qui s’applique. Matière végétale : 1 jour Pierre ou cristal : 12 heures Métaux précieux : 1 heure Gemmes : 10 minutes Adamantium ou mithral : 1 minute Si vous utilisez les matériaux créés via ce sort comme composantes matérielles pour un autre sort, ce dernier échoue. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 6 ou supérieur, l’arête du cube augmente de 1,50 mètre par niveau au-delà du niveau 5.'
    },
    {
        id: 663,
        nom: 'Déblocage',
        ...
        composantes: 'V',
        duree: 'instantanée',
        description: 'Choisissez un objet situé à portée et dans votre champ de vision. Ce peut être une porte, une boîte, un coffre, des menottes, un cadenas ou un autre objet disposant d’un système de fermeture ordinaire ou magique. Une cible fermée par une serrure ordinaire, coincée ou bloquée par une barre se déverrouille ou se débloque. Si l’objet a plusieurs serrures, le sort en ouvre une seule. Si vous visez une cible fermée par un verrou magique, ce dernier est supprimé pendant 10 minutes, au cours desquelles on peut ouvrir et fermer la cible normalement. Quand vous lancez le sort, un cliquetis émane de l’objet et retentit si fort qu’on l’entend dans un rayon de 90 mètres.'
    },
    {
        id: 664,
        nom: 'Déguisement',
    ...
    },
    {
        ...
        composantes: 'V, S, M (une lame de fer et un petit sac contenant un mélange de terres : de l’argile, du terreau et du sable)',
        duree: 'concentration, jusqu’à 2 heures',
        description: 'Choisissez une zone de terrain à portée d’au maximum 12 mètres de côté. Vous pouvez remodeler la terre, le sable ou l’argile qu’elle comporte comme bon vous semble pendant toute la durée du sort. Vous pouvez augmenter ou diminuer l’altitude de la zone, creuser ou combler une tranchée, ériger ou abattre un mur, ou former un pilier. L’amplitude de ces modifications ne peut pas excéder la moitié de la dimension la plus importante de la zone affectée. Donc, si vous modifiez une zone de 12 mètres de côté, vous pouvez créer un pilier de 6 mètres de haut au maximum, modifier l’altitude de la zone de 6 mètres au plus, creuser une tranchée d’un maximum de 6 mètres de profondeur, etc. Il faut 10 minutes pour finaliser ces modifications. Au bout de chaque période de 10 minutes passées à vous concentrer sur le sort, vous pouvez choisir une nouvelle zone de terrain à modifier. Comme les transformations se produisent lentement, il est bien rare qu’une créature se retrouve piégée ou blessée à cause des mouvements du terrain. Ce sort est incapable de manipuler la pierre naturelle et les constructions de pierre. La roche et les structures s’adaptent au nouvel agencement du terrain. Si vos modifications déstabilisent une structure, elle peut très bien s’effondrer. De même, le sort n’affecte pas directement la croissance des plantes. La terre déplacée emporte les végétaux avec elle.'
    },
    {
        id: 666,
        nom: 'Désintégration',
        ...
        composantes: 'V, S, M (de la magnétite et une pincée de poussière)',
        duree: 'instantanée',
        description: 'Un mince rayon de lumière verte jaillit de votre doigt pointé vers une cible située dans votre champ de vision et à portée. La cible peut être une créature, un objet ou une création de force magique, comme une barrière issue d’un mur de force. Une créature visée par ce sort doit faire un jet de sauvegarde de Dextérité. Si elle le rate, elle subit 10d6+40 dégâts de force. Si ces dégâts la réduisent à 0 point de vie, elle est désintégrée. Une créature désintégrée est réduite à l’état de fine poussière grise, tout comme tous les objets qu’elle porte et transporte, à l’exception des objets magiques. Pour ressusciter une créature ainsi désintégrée, il faut impérativement recourir à une résurrection suprême ou un souhait. Ce sort désintègre automatiquement les objets non magiques de taille G ou inférieure et les créations magiques de force. Si la cible est un objet de taille TG ou supérieure, le sort désintègre un cube de 3 mètres d’arête au sein de l’objet. Ce sort reste sans effet sur les objets magiques. À plus haut niveau. Si vous lancez ce sort en utilisant un emplacement de niveau 7 ou supérieur, les dégâts augmentent de 3d6 par niveau au-delà du niveau 6.'
    },
    {
        id: 667,
        nom: 'Détection de la magie',
    ...
    },
    {
        ...
        duree: 'instantanée',
        description: 'Un geyser d’énergie jaillit du sol d’un endroit que vous spécifiez dans la portée du sort. Vous choisissez acide, foudre, feu, froid, poison ou tonnerre comme type d’énergie pour le geyser. Chaque créature située dans le cylindre de 1,50 mètre de diamètre et de 6 mètres de haut doit réussir un jet de sauvegarde de Dextérité, sans quoi elle subit 3d8 dégâts du type préalablement déterminé. Si le jet est réussi, les dégâts sont réduits de moitié. À plus haut niveau. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les dégâts sont augmentés de 1d8 par niveau au-delà du niveau 1.'
    },
    {
        id: 683,
        nom: 'Globe d’invulnérabilité',
    ...
    },
    {
        ...
        composantes: 'V, S, M (un bout de liège)',
        duree: '1 heure',
        description: 'Ce sort permet de se déplacer sur n’importe quelle surface liquide (comme de l’eau, de l’acide, de la boue, de la neige, des sables mouvants ou de la lave) comme s’il s’agissait d’un sol ferme et inoffensif (ceci dit, les créatures qui marchent sur la lave subissent tout de même les dégâts liés à la chaleur dégagée). Vous pouvez accorder cette capacité pendant toute la durée du sort à un maximum de dix créatures consentantes situées à portée et dans votre champ de vision. Si vous prenez pour cible une créature immergée dans un liquide, le sort la ramène à la surface du liquide à une vitesse de 18 mètres par round.'
    },
    {
        id: 704,
        nom: 'Mauvais œil',
    ...
    },
    {
        ...
        duree: 'Instantanée',
        description: "Vous touchez un humanoïde mort ou un morceau du cadavre d'une telle créature. Si la créature est morte depuis 10 jours ou moins, le sort lui fabrique un nouveau corps adulte et y appelle son âme. Le sort échoue si l'âme n'est pas libre de gagner ce corps ou si elle ne le désire pas. La magie façonne un nouveau corps pour accueillir l'âme, ce qui risque de modifier la race de la créature ; le MJ détermine au hasard, ou choisit, quel sera le corps de la créature ramenée à la vie. La créature réincarnée se souvient de son ancienne vie et de ses expériences passées. Elle conserve les capacités dont elle disposait sous sa forme d'origine, mais échange sa race précédente contre la nouvelle et modifie ses traits raciaux en conséquence."
    },
    {
        id: 764,
        ...
        duree: "Concentration, jusqu'à 1 minute",
        description: "Vous créez une gigantesque tempête de sable qui balaye tout sur son passage. La vague de sable mesure 150 mètres de large, 24 mètres de long et 24 mètres de haut. Elle débute au point désigné situé à portée puis se déplace à une vitesse de 24 mètres par round dans la direction de votre choix. Une fois la direction fixée, il n'est plus possible d'en modifier la course. La vague inflige 8d6 dégâts contondants à toute créature qui se trouve sur son passage ; un jet de sauvegarde de Force réussi réduit les dégâts de moitié. Les créatures de taille G ou inférieure qui le ratent sont emportées dans les airs et subissent 3d6 dégâts supplémentaires, tandis que les créatures de taille TG ou supérieure tombent à terre. Tant qu'une créature se trouve dans la zone d'effet, elle est aveuglée et bénéficie d'un abri important. Si ce sort est lancé dans un désert de sable ou de pierre, il inflige 4d6 dégâts supplémentaires (divisés par deux en cas de réussite du jet de sauvegarde)."
    },
    {
        id: 765,
        nom: 'Tempête vengeresse',
        classe: ['Druide'],
        niveau: 9,
        ecole: 'Invocation',
        temps: '1 action',
        ...
        composantes: 'V, S',
        duree: "Concentration, jusqu'à 1 minute",
        description: "De menaçantes nuées orageuses se forment en un point situé dans votre champ de vision et s'étendent dans un rayon de 110 mètres. Des éclairs strient la zone, le tonnerre gronde et un vent fort se lève. Chaque créature située sous le nuage lors de son apparition doit faire un jet de sauvegarde de Constitution ; en cas d'échec, elle subit 2d6 dégâts de tonnerre et est assourdie pendant 5 minutes. À chaque round où vous continuez à vous concentrer sur ce sort, il génère des effets supplémentaires : une pluie acide au round 2 (1d6 dégâts d'acide), six éclairs au round 3 (10d6 dégâts de foudre, moitié en cas de réussite), de la grêle au round 4 (2d6 dégâts contondants), puis des bourrasques et une pluie glacée aux rounds 5 à 10 qui transforment la zone en terrain difficile où la visibilité est nulle et infligent 1d6 dégâts de froid, rendant également impossible toute attaque à distance dans la zone."
    },
    {
        id: 766,
        nom: 'Transport végétal',
        classe: ['Druide'],
        niveau: 6,
        ecole: 'Invocation',
        temps: '1 action',
...
let favoris = JSON.parse(localStorage.getItem('grimoire_favoris')) || [];
...
function filtrerSorts() {
    ...
    const resultats = SORTS.filter(sort => {
        const matchTexte = sort.nom.toLowerCase().includes(texte) || sort.description.toLowerCase().includes(texte);
        const matchClasse = classe === "" || sort.classe.includes(classe);
        const matchNiveau = niveau === "" || sort.niveau.toString() === niveau;
        return matchTexte && matchClasse && matchNiveau;
    });

    afficherCartes(resultats, 'resultats-liste');
}

// Affichage des cartes
function afficherCartes(listeSorts, containerId) {
    const container = document.getElementById(containerId);
    container.innerHTML = "";

    if (listeSorts.length === 0) {
        container.innerHTML = "<p style='grid-column: 1/-1; text-align: center; color: var(--text-muted);'>Aucun sort trouvé.</p>";
        return;
    }

    listeSorts.forEach(sort => {
        const isFav = favoris.includes(sort.id);
        const card = document.createElement('div');
        card.className = 'sort-card';
        card.innerHTML = `
            <div>
                <h3>${sort.nom}</h3>
                <span class="badge">Niveau ${sort.niveau === 0 ? 'Tour de magie' : sort.niveau} • ${sort.ecole}</span>
                <p><strong>Classes :</strong> ${sort.classe.join(', ')}</p>
                <p><strong>Temps :</strong> ${sort.temps}</p>
            </div>
            <div class="card-actions">
                <button class="btn-card btn-detail" onclick="ouvrirModal(${sort.id})">Détails</button>
                <button class="btn-card btn-fav ${isFav ? 'active' : ''}" onclick="toggleFavori(${sort.id})">
                    ${isFav ? '★ Dans le grimoire' : '☆ Ajouter'}
                </button>
            </div>
        `;
...
function afficherFavoris() {
    const sortsFavoris = SORTS.filter(sort => favoris.includes(sort.id));
    afficherCartes(sortsFavoris, 'favoris-liste');
}
...
function toggleFavori(id) {
    ...
    localStorage.setItem('grimoire_favoris', JSON.stringify(favoris));
    updateFavCount();

    // Rafraîchir l'affichage
    filtrerSorts();
    if (document.getElementById('section-favoris').classList.contains('active')) {
        afficherFavoris();
    }
}
...
function ouvrirModal(id) {
    ...
    modalBody.innerHTML = `
        <h2>${sort.nom}</h2>
        <p><em>${sort.niveau === 0 ? 'Tour de magie' : 'Sort de niveau ' + sort.niveau} - ${sort.ecole}</em></p>
        <div class="modal-meta">
            <div><strong>Classes :</strong> ${sort.classe.join(', ')}</div>
            <div><strong>Temps :</strong> ${sort.temps}</div>
            <div><strong>Portée :</strong> ${sort.portee}</div>
            <div><strong>Durée :</strong> ${sort.duree}</div>
            <div style="grid-column: 1 / -1;"><strong>Composantes :</strong> ${sort.composantes}</div>
        </div>
        <p><strong>Description :</strong></p>
        <p style="line-height: 1.5;">${sort.description}</p>
    `;

    document.getElementById('spell-modal').style.display = 'flex';
}

function fermerModal(event, force = false) {
    if (force || event.target.id === 'spell-modal') {
